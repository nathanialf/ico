...
if [ "${BASE}" = "0FBBE0" ]; then
    "${PYTHON}" "${ROOT}/tools/postprocess_0FBBE0.py" "${S}"
fi
if [ "${BASE}" = "00A3A0" ]; then
    "${PYTHON}" "${ROOT}/tools/postprocess_00A3A0.py" "${S}"
fi
if [ "${BASE}" = "01BF60" ]; then
    "${PYTHON}" "${ROOT}/tools/postprocess_01BF60.py" "${S}"
fi
if [ "${BASE}" = "09F530" ]; then
    "${PYTHON}" "${ROOT}/tools/postprocess_09F530.py" "${S}"
fi
if [ "${BASE}" = "0D4E30" ]; then
    "${PYTHON}" "${ROOT}/tools/postprocess_0D4E30.py" "${S}"
fi
if [ "${BASE}" = "0CE718" ]; then
...
if [ "${BASE}" = "itou_boss" ]; then
    "${PYTHON}" "${ROOT}/tools/postprocess_itou_boss.py" "${S}"
fi
