...
Writes:
  * docs/pal_source_tree.md    (tracked) -- the human-readable census.
  * docs/pal_source_tree.json  (tracked) -- the same, machine-readable.
...
Machine-readable twin: `docs/pal_source_tree.json`.
