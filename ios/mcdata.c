...
INCLUDE_ASM("asm/nonmatchings/ios/mcdata", iosMcGetDir);
...
INCLUDE_ASM("asm/nonmatchings/ios/mcdata", iosMcSaveProductBlock);

INCLUDE_ASM("asm/nonmatchings/ios/mcdata", iosMcLoadProductBlock);

INCLUDE_ASM("asm/nonmatchings/ios/mcdata", iosMcSaveGameBlock);

INCLUDE_ASM("asm/nonmatchings/ios/mcdata", iosMcLoadGameBlock);

INCLUDE_ASM("asm/nonmatchings/ios/mcdata", iosMcChdirProduct);

INCLUDE_ASM("asm/nonmatchings/ios/mcdata", iosMcGetBlockSaveInfo);
