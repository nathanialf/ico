...
const char D_00557C50[24] = "Spu2DmaWriteEe2Iop\n";
const char D_00557C68[24] = "ee %x iop %x size %x\n";
const char D_00557C80[32] = "send SpuStEnv completed \n";
const char D_00557CA0[16] = "SgInit()\n";
const char D_00557CB0[24] = "SgSetTickMode()\n";
const char D_00557CC8[16] = "sound/s_init.c";
const char D_00557CD8[24] = "\nCan't alloc heap \n";
const char D_00557CF0[40] = "iop sound alloced 0x%x  size %d\n";
const char D_00557D18[16] = "se open\n";
const char D_00557D28[24] = "bgm request buff over\n";
const char D_00557D40[16] = "bgm not open\n";
const char D_00557D50[16] = "bgm play\n";
const char D_00557D60[32] = "soundBufAdpcmChAlloc over\n";
const char D_00557D80[16] = "center x";
const char D_00557D90[16] = "center y";
const char D_00557DA0[16] = "volumeRate";
const char D_00557DB0[24] = "max volume range";
const char D_00557DC8[16] = "attenuator";
const char D_00557DD8[16] = "volume length";
const char D_00557DE8[16] = "max volume type";
const char D_00557DF8[16] = "stereo rate";
const char D_00557E08[24] = "req no %d %s %f\n";
const char D_00557E20[16] = "%s%8s = %d\n";
const char D_00557E30[16] = "%s%8s = %f\n";
const char D_00557E50[24] = "se request buff over\n";
const char D_00557E68[16] = "se not open\n";
const char D_00557E78[16] = "num %d %d\n";
const char D_00557E88[24] = "sound manager in\n";
const char D_00557EA0[16] = "IosSndLock %d\n";
const char D_00557EB0[32] = "SOUND MANAGER START\n";
const char D_00557ED0[16] = "with mail\n";
