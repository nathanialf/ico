...
~99 KB of it (§3b) being proprietary-SDK code matched from the disassembly with no
reference implementation, which is the slowest kind of matching there is.

---

## 5. Two items on the wrong side of the cut, documented but not reclassified
