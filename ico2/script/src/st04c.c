...
INCLUDE_ASM("asm/nonmatchings/ico2/script/src/st04c", actSt04cDoorDownChk);
INCLUDE_ASM("asm/nonmatchings/ico2/script/src/st04c", actSt04cIntroChk);
INCLUDE_ASM("asm/nonmatchings/ico2/script/src/st04c", actSt04lDoorChk);
