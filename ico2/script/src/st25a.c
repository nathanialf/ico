...
INCLUDE_ASM("asm/nonmatchings/ico2/script/src/st25a", actSt25aQueenAppearChk);
...
INCLUDE_ASM("asm/nonmatchings/ico2/script/src/st25a", actConte12Jimaku);
ASM_LIT4_SLOT(D_006390EC, 4200.0f);
INCLUDE_ASM("asm/nonmatchings/ico2/script/src/st25a", actSt25aQueenDeadChk);
INCLUDE_ASM("asm/nonmatchings/ico2/script/src/st25a", actConte13Jimaku);
...
INCLUDE_ASM("asm/nonmatchings/ico2/script/src/st25a", actSt25aElevChk);
