...
INCLUDE_ASM("asm/nonmatchings/ico2/sugipon/src/motionOrientManager", GetNbMotionFrames);
INCLUDE_ASM("asm/nonmatchings/ico2/sugipon/src/motionOrientManager", GetMotionPlaySpeedRatio);
INCLUDE_ASM("asm/nonmatchings/ico2/sugipon/src/motionOrientManager", execFrameTrigger);
...
INCLUDE_ASM("asm/nonmatchings/ico2/sugipon/src/motionOrientManager", shiftMotionOrientEndFunc);
