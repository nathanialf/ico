...
INCLUDE_ASM("asm/nonmatchings/ico2/ito/src/queen_barrier_disp", makeRefractST);
INCLUDE_ASM("asm/nonmatchings/ico2/ito/src/queen_barrier_disp", queen_barrier_disp_proc);
INCLUDE_ASM("asm/nonmatchings/ico2/ito/src/queen_barrier_disp", queen_barrier_disp_init);
