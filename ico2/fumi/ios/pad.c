...
INCLUDE_ASM("asm/nonmatchings/ico2/fumi/ios/pad", iosPadDevReadFunc);
INCLUDE_ASM("asm/nonmatchings/ico2/fumi/ios/pad", iosPadRead);
INCLUDE_ASM("asm/nonmatchings/ico2/fumi/ios/pad", iosPadNormalizeStick);
INCLUDE_ASM("asm/nonmatchings/ico2/fumi/ios/pad", iosPadGetStick_func);
