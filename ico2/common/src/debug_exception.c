...
INCLUDE_ASM("asm/nonmatchings/ico2/common/src/debug_exception", traceLine);
...
INCLUDE_ASM("asm/nonmatchings/ico2/common/src/debug_exception", debugEEExceptionMain);
