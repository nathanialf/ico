...
INCLUDE_ASM("asm/nonmatchings/ico2/omori/src/chain", chain_simulate_stop);
ASM_LIT4_SLOT(D_00639190, 0.675f);
INCLUDE_ASM("asm/nonmatchings/ico2/omori/src/chain", chain_simulate_free);
ASM_LIT4_SLOT(D_00639194, 3.1415927f);
INCLUDE_ASM("asm/nonmatchings/ico2/omori/src/chain", correct_vector);
...
INCLUDE_ASM("asm/nonmatchings/ico2/omori/src/chain", chain_set_charachara);
...
INCLUDE_ASM("asm/nonmatchings/ico2/omori/src/chain", ChainDL);
INCLUDE_ASM("asm/nonmatchings/ico2/omori/src/chain", GetPositionOnTheChain);
INCLUDE_ASM("asm/nonmatchings/ico2/omori/src/chain", PlumbPointUpdateChain);
...
INCLUDE_ASM("asm/nonmatchings/ico2/omori/src/chain", SetChainRootUpdateMode);
