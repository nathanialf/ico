...
extern PObjGObj *isysGObjMoveBeforeGObj(int a0, int a1, int a2);
extern void isysGObjMoveObjDLAfterGObj(void *a0, int a1, int a2, int a3, unsigned int a4);
extern int isysGObjProcPause(void *a0, int a1, int a2, int a3);
extern void isysGObjProcPauseAll(void *a0, int a1, int a2, int a3, int a4);
extern void isysGObjRemove(void *a0, int a1);

extern PObjGObj *D_0070C340_p[] __asm__("D_0070C340");

PObjGObj *func_0023D260(PObjGObj *p, int a1, int a2, int a3, int a4) {
    PObjGObj *g;
    int one;
    int r21 = 0;
    int c5C, c50, c4C, c48;
    ...
    c4C = p->f4C;
    c48 = p->f48;
    g = isysGObjMoveBeforeGObj(p->f60, 0, 0);
    one = 1;
    g->f164 = 0;
    g->f04 = one;
    g->f16C = one;
    g->f08 = -1;
    g->f0C = -1;
    D_0070C340_p[D_0062BEA0++] = g;
    isysGObjProcPause(g, c5C, one, 0x16);
    isysGObjProcPause(g, c50, one, 0x17);
    isysGObjProcPause(g, c4C, one, 0x18);
    isysGObjMoveObjDLAfterGObj(g, c48, 0, a3, 0xFFFFFFFF);
    if (r21 != 0) {
        isysGObjProcPauseAll(g, r21, 0, 0x13, 0x1800);
    }
    g->f08 = a2;
    isysGObjRemove(g, a1);
    return g;
...
int sceSifGetOtherData(void *a0, int a1, int a2, int a3, int a4) {
    ...
    obj = _sceRpcGetPacket(D_0070E240);
    if (obj == 0) {
        return -1;
    }
    *(void **)((char *)a0 + 0) = obj;
...
int sceDclose(unsigned int a0) {
    ...
    buf[2] = 0;
    buf[5] = 0;
    D_0070E2C0[0] = h = CreateSema(buf);
    *(void **)(g + 1) = &result;
    g[2] = 4;
    rc = sceSifCallRpc(D_0070F580, 0xA, 0, g, 0x14, D_0070EF00, 4, 0, 0);
    if (rc < 0) {
        DeleteSema(h);
        func_00243628();
        return -0xB;
...
int sceDread(unsigned int a0, int a1) {
    ...
    buf[2] = 0;
    buf[5] = 0;
    D_0070E2C0[0] = a1 = CreateSema(buf);
    *(void **)(g + 1) = &result;
    g[2] = 4;
    rc = sceSifCallRpc(D_0070F580, 0xB, 0, g, 0x20, D_0070EF00, 4, 0, 0);
    if (rc < 0) {
        WaitSema(a1);
        func_00243628();
        return -0xB;
...
extern void func_002483F8(void *a0, int a1);
extern int sceSifSetDma(void *a0, int a1);
extern int isceSifSetDma(void *a0, int a1);
...
void sceCdDelayThread(unsigned short a0) {
    ...
    buf[5] = 0;
    r = CreateSema(buf);
    SetAlarm(id, (char *)func_002484A4 + 4, r);
    WaitSema(r);
    DeleteSema(r);
}
...
extern int D_0054ABD4[];
extern int D_0054AC14[];
extern int D_0054ABE0[];
extern int D_0054ABE8[];
extern int D_0054ABEC[];

void cdvd_exit(void) {
    if (D_0054ABD4[0] != 0) {
        *(volatile int *)D_0054AC14 = -1;
        SignalSema(*(volatile int *)D_0054ABE0);
    }
    DeleteSema(*(volatile int *)D_0054ABE8);
    DeleteSema(*(volatile int *)D_0054ABEC);
    DeleteSema(*(volatile int *)D_0054ABE0);
    (*(int (*)(void))DIntr)();
    sceSifRemoveCmdHandler(0x80000012);
    EIntr();
}

extern int D_0054ABFC[];
...
int sceCdPOffCallback(int a0, int a1) {
    ...
    (*(int (*)(void))DIntr)();
    ret = (int)D_00710F84[0];
    D_00710F88[0] = a1;
    D_00710F84[0] = (void (*)(int))a0;
    EIntr();
    return ret;
}
...
extern void _sceCd_cd_callback();
...
int func_00249AC0(int a0, int a1, int a2, unsigned char *a3) {
    ...
    *hp = 1;
    *hp2 = 1;
    if (sceSifCallRpc(D_0054BD90, 0xD, 1, p, 0x18, 0, 0, _sceCd_cd_callback, (int *)hp) < 0) {
        *hp = 0;
        *hp2 = 0;
        SignalSema(*(volatile int *)D_0054ABE8);
        return 0;
    }
    if (D_0054ABD0[0] > 0) {
        scePrintf(D_00628AD8);
    }
    return 1;
    }
}
...
void _send_to_iop(int a0, int a1) {
    ...
    int ret = sceSifDmaStat(D_007112D0[a0][a1].fC);
...
int scePadInit(int a0) {
    ...
    *(volatile int *)D_0054C648 = 1;
    ...
    if (hi != 4) {
        if (D_0054C64C[0] != 0) {
            printf(D_00628C50);
            printf(D_00628C78, 4, 0, hi, v & 0xFF);
        }
        return 0;
    }
...
int func_0024C290(int a0, int a1, char *a2, int a3, int a4, int a5) {
    int *obj;
    int r;
    ...
    *((char *)D_007116F0 + 0x413) = 0;
    if (a4 >= 0) {
        func_002483F8((void *)a5, a4 << 6);
    }
    r = sceSifCallRpc(D_00711640, 0xD, 1, D_007116F0, 0x414, D_00712C00, 4, 0, 0);
    if (r == 0) {
        *(int *)D_0054C690 = 0xD;
    } else {
        SignalSema(D_0054C694[0]);
...
int func_0024C470(int a0, int a1, char *a2, int a3) {
    ...
    *((char *)D_007116F0 + 0x413) = 0;
    ...
    r = sceSifCallRpc(D_00711640, 0xC, 1, D_007116F0, 0x414, D_00712C00, 4, mceStorePwd, a3);
    if (r == 0) {
        *(int *)D_0054C690 = 0xC;
    } else {
        SignalSema(D_0054C694[0]);
...
extern void _dispatchMpegCbNodata(void *a0);
...
extern void *D_0054C764[];
extern int D_0054C800[];
extern int D_0054C840[];
extern unsigned int D_0054C8A0[];
extern int D_0054C8A4[];
extern int D_0054C8B0[];
extern int D_0054C8B4[];
extern unsigned int D_0054C8B8[];
extern int D_0054C8BC[];
extern int D_0054C8C0[];
extern int D_0054D020[];
extern int D_0054D024[];
extern int D_00628ED8[];
extern int _nextBit(int a0);
extern void _Error(void *a0);
extern void _waitIpuIdle(void);
extern void _sendIpuCommand(unsigned int a0);
extern void _setDefaultQM(void *a0, int a1);
...
/* m2c scaffold from asm/aug6/nonmatchings/common/src/PObj/fmodf.s (target mipsel-gcc-c, context-free).
 * NOT a match — reshape into a goto-CFG-mirror + recover intent (see decomp-match skill). */
extern int D_00629998[];

float fmodf(float a, float b) {
    extern float __ieee754_fmodf(float a0, float a1);
    extern float dptofp(long a0);
    ...
    if (D_00629998[0] == 2 || matherr(&buf) == 0) {
...
/* fdlibm __kernel_cosf(x, y): cosine kernel on |x| <= pi/4, y the tail. */
...
/* memset: hand-vectorized memset(dst, c, n) — for n >= 8 on a 16-aligned
 ...
 * siblings in this TU (strcat, sceGsResetPath) use the same
...
void _sprintf_r(void *a0, int a1, int a2, ...) {
    char buf[0x60];
...
int _malloc_trim_r(int *self, unsigned int a1) {
    ...
    if (_sbrk_r(self, 0) != (int)D_0054D520.blk + (int)A) {
        goto fail;
    }
 ...
 * if(r)ret 0; r=_malloc_r(a0,0x80); f_1D4=r; if(!r)ret -1; clear 32 ints from
...
int __sread(void *a0, int a1, int a2) {
    long v = func_0026B0B8((int *)*(int *)((char *)a0 + 0x54), *(short *)((char *)a0 + 0xE), a1, a2);
    if ((int)v >= 0) {
...
long __sseek(void *a0, int a1, int a2) {
    unsigned long r = (unsigned long)func_0026B058((int *)*(int *)((char *)a0 + 0x54), *(short *)((char *)a0 + 0xE), a1, a2);
    if (r == -1) {
...
extern long long __fixunsdfdi(long a0);
...
long long __fixdfdi(long a0) {
    ...
    zero = z.l;
    if (dpcmp(a0, zero) < 0)
        return -__fixunsdfdi(dpsub(zero, a0));
    return __fixunsdfdi(a0);
}
