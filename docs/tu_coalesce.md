# TU coalesce queue — cod-shim count desc

Auto-generated cod-shim reduction shortlist. Drives the active coalesce sprint and `decomp/PROMOTE.md`. For per-function placement recommendations see [`decomp/placement_plan.md`](../decomp/placement_plan.md). For the matching picker see [`docs/tu_candidates.md`](tu_candidates.md).

- Generated: 2026-05-17 01:52:51 UTC
- Source: `tools/tu_candidates.py`
- Per-TU sort: cod_shim count desc (most shims first).

**Total cod shims across all TUs: 1154** (reduction target).

## Top 40 TUs by cod-shim count
...
### src/box.c
_text 0/25 (0%) · coal 0/25 · cod 25 · uninsn 3730 · data 45/68_

**uncategorized** (25)

| vram | size | subseg |
| --- | ---: | --- |
| `0x001BEC30` | 0xD0 | src/cod/0BC9C8 |
| `0x001BFFE8` | 0xD8 | src/cod/0BC9C8 |
| `0x001BEE60` | 0xF8 | src/cod/0BC9C8 |
| `0x001BD668` | 0x108 | src/cod/0BC9C8 |
| `0x001BF7F8` | 0x120 | src/cod/0BC9C8 |
| `0x001BCAF0` | 0x128 | src/cod/0BC9C8 |
| `0x001BE120` | 0x130 | src/cod/0BC9C8 |
| `0x001BD138` | 0x140 | src/cod/0BC9C8 |
| `0x001BE558` | 0x150 | src/cod/0BC9C8 |
| `0x001BF6A0` | 0x158 | src/cod/0BC9C8 |
| `0x001BED00` | 0x160 | src/cod/0BC9C8 |
| `0x001BF148` | 0x180 | src/cod/0BC9C8 |
| `0x001BD278` | 0x190 | src/cod/0BC9C8 |
| `0x001BF2C8` | 0x198 | src/cod/0BC9C8 |
| `0x001BDA70` | 0x1E8 | src/cod/0BC9C8 |
| `0x001BEF58` | 0x1F0 | src/cod/0BC9C8 |
| `0x001BF460` | 0x240 | src/cod/0BC9C8 |
| `0x001BD408` | 0x260 | src/cod/0BC9C8 |
| `0x001BD770` | 0x300 | src/cod/0BC9C8 |
| `0x001BE250` | 0x308 | src/cod/0BC9C8 |
| `0x001C00C0` | 0x478 | src/cod/0BC9C8 |
| `0x001BDC58` | 0x4C8 | src/cod/0BC9C8 |
| `0x001BCC18` | 0x520 | src/cod/0BC9C8 |
| `0x001BE6A8` | 0x588 | src/cod/0BC9C8 |
| `0x001BF918` | 0x6D0 | src/cod/0BC9C8 |
...
### src/Packet.c
_text 0/19 (0%) · coal 0/19 · cod 19 · uninsn 2740 · data 52/70_

**uncategorized** (19)

| vram | size | subseg |
| --- | ---: | --- |
| `0x0011A2A8` | 0x48 | src/cod/018FD4 |
| `0x0011A2F0` | 0x48 | src/cod/018FD4 |
| `0x0011A238` | 0x70 | src/cod/018FD4 |
| `0x00119470` | 0xD0 | src/cod/018FD4 |
| `0x0011A338` | 0xD8 | src/cod/018FD4 |
| `0x0011A410` | 0x110 | src/cod/018FD4 |
| `0x0011A520` | 0x148 | src/cod/018FD4 |
| `0x0011B1F0` | 0x170 | src/cod/018FD4 |
| `0x0011ACF8` | 0x180 | src/cod/018FD4 |
| `0x0011A668` | 0x190 | src/cod/018FD4 |
| `0x0011A7F8` | 0x198 | src/cod/018FD4 |
| `0x0011B040` | 0x1B0 | src/cod/018FD4 |
| `0x0011AE78` | 0x1C8 | src/cod/018FD4 |
| `0x001199A0` | 0x300 | src/cod/018FD4 |
| `0x0011A990` | 0x368 | src/cod/018FD4 |
| `0x0011B360` | 0x378 | src/cod/018FD4 |
| `0x00119540` | 0x460 | src/cod/018FD4 |
| `0x00119CA0` | 0x598 | src/cod/018FD4 |
| `0x0011B6D8` | 0x868 | src/cod/018FD4 |
...
### src/charFileManager.c
_text 0/18 (0%) · coal 0/18 · cod 18 · uninsn 1800 · data 101/468_

**uncategorized** (18)

| vram | size | subseg |
| --- | ---: | --- |
| `0x001A26E0` | 0x78 | src/cod/0A1138 |
| `0x001A20D8` | 0x98 | src/cod/0A1138 |
| `0x001A2758` | 0xA0 | src/cod/0A1138 |
| `0x001A2610` | 0xD0 | src/cod/0A1138 |
| `0x001A16B8` | 0x108 | src/cod/0A1138 |
| `0x001A1D88` | 0x108 | src/cod/0A1138 |
| `0x001A2500` | 0x110 | src/cod/0A1138 |
| `0x001A2C18` | 0x140 | src/cod/0A1138 |
| `0x001A2AB0` | 0x168 | src/cod/0A1138 |
| `0x001A2170` | 0x1B0 | src/cod/0A1138 |
| `0x001A1138` | 0x1D0 | src/cod/0A1138 |
| `0x001A1308` | 0x1D0 | src/cod/0A1138 |
| `0x001A14D8` | 0x1E0 | src/cod/0A1138 |
| `0x001A2320` | 0x1E0 | src/cod/0A1138 |
| `0x001A1E90` | 0x248 | src/cod/0A1138 |
| `0x001A17C0` | 0x258 | src/cod/0A1138 |
| `0x001A27F8` | 0x2B8 | src/cod/0A1138 |
| `0x001A1A18` | 0x370 | src/cod/0A1138 |
...
### src/fieldCollision.c
_text 0/14 (0%) · coal 0/14 · cod 14 · uninsn 1910 · data 48/98_

**uncategorized** (12)

| vram | size | subseg |
| --- | ---: | --- |
| `0x00167278` | 0x8 | src/cod/067258 |
| `0x00167760` | 0x70 | src/cod/067280 |
| `0x00166028` | 0xF0 | src/cod/066024 |
| `0x00166118` | 0x140 | src/cod/066024 |
| `0x00166A10` | 0x1A0 | src/cod/066024 |
| `0x001667E0` | 0x230 | src/cod/066024 |
| `0x00167528` | 0x238 | src/cod/067280 |
| `0x00166BB0` | 0x260 | src/cod/066024 |
| `0x00167280` | 0x2A8 | src/cod/067280 |
| `0x00166E10` | 0x420 | src/cod/066024 |
| `0x00166258` | 0x588 | src/cod/066024 |
| `0x001677D0` | 0x630 | src/cod/067280 |

### src/Primitive.c
_text 0/13 (0%) · coal 0/13 · cod 13 · uninsn 1966 · data 37/40_

**uncategorized** (13)

| vram | size | subseg |
| --- | ---: | --- |
| `0x0011D590` | 0xC8 | src/cod/01BFC0 |
| `0x0011D730` | 0xD0 | src/cod/01BFC0 |
| `0x0011D658` | 0xD8 | src/cod/01BFC0 |
| `0x0011D800` | 0x1A0 | src/cod/01BFC0 |
| `0x0011DD08` | 0x1D8 | src/cod/01BFC0 |
| `0x0011C2B8` | 0x248 | src/cod/01BFC0 |
| `0x0011C028` | 0x290 | src/cod/01BFC0 |
| `0x0011CBF8` | 0x298 | src/cod/01BFC0 |
| `0x0011D2E8` | 0x2A8 | src/cod/01BFC0 |
| `0x0011C500` | 0x368 | src/cod/01BFC0 |
| `0x0011D9A0` | 0x368 | src/cod/01BFC0 |
| `0x0011C868` | 0x390 | src/cod/01BFC0 |
| `0x0011CE90` | 0x458 | src/cod/01BFC0 |
...
### src/clothAnimation.c
_text 0/11 (0%) · coal 0/11 · cod 11 · uninsn 3110 · data 120/150_

**uncategorized** (11)

| vram | size | subseg |
| --- | ---: | --- |
| `0x001C5FD0` | 0xC0 | src/cod/0C3984 |
| `0x001C62D0` | 0xF8 | src/cod/0C3984 |
| `0x001C6090` | 0x240 | src/cod/0C3984 |
| `0x001C8218` | 0x260 | src/cod/0C3984 |
| `0x001C7FB0` | 0x268 | src/cod/0C3984 |
| `0x001C58C0` | 0x2E0 | src/cod/0C3984 |
| `0x001C5BA0` | 0x430 | src/cod/0C3984 |
| `0x001C6998` | 0x458 | src/cod/0C3984 |
| `0x001C8478` | 0x4E0 | src/cod/0C3984 |
| `0x001C63C8` | 0x5D0 | src/cod/0C3984 |
| `0x001C6DF0` | 0x11C0 | src/cod/0C3984 |
...
### ios/inflate.c
_text 0/10 (0%) · coal 0/10 · cod 10 · uninsn 2366 · data 10/20_

**uncategorized** (9)

| vram | size | subseg |
| --- | ---: | --- |
| `0x00135A48` | 0x90 | src/cod/0354B8 |
| `0x001354B8` | 0xC8 | src/cod/0354B8 |
| `0x00135AD8` | 0xE0 | src/cod/0354B8 |
| `0x001348F0` | 0x260 | src/cod/033604 |
| `0x001345D0` | 0x320 | src/cod/033604 |
| `0x00135580` | 0x4C8 | src/cod/0354B8 |
| `0x00133E88` | 0x748 | src/cod/033604 |
| `0x001336C0` | 0x7C8 | src/cod/033604 |
| `0x00134B50` | 0x918 | src/cod/033604 |

### ios/memory.c
_text 0/9 (0%) · coal 0/9 · cod 9 · uninsn 1268 · data 61/64_

**uncategorized** (9)

| vram | size | subseg |
| --- | ---: | --- |
| `0x001394F0` | 0xA8 | src/cod/0383F8 |
| `0x0013A0F8` | 0x108 | src/cod/0383F8 |
| `0x00139FE8` | 0x110 | src/cod/0383F8 |
| `0x00139C30` | 0x148 | src/cod/0383F8 |
| `0x00139A50` | 0x1E0 | src/cod/0383F8 |
| `0x001392A8` | 0x248 | src/cod/0383F8 |
| `0x00139D78` | 0x270 | src/cod/0383F8 |
| `0x00138E30` | 0x478 | src/cod/0383F8 |
| `0x00139598` | 0x4B8 | src/cod/0383F8 |
