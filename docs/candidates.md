...
- Generated: 2026-05-08 02:43:34 UTC
...
- Functions: 4383 total in `asm/cod/*.s`, 23 parked, 4360 considered
...
| `func_0013F930` | 0x30 | 12 | 1 |  | `daddu addiu andi daddu` | asm/cod/03F930.s:13 |

<a id="wrap-1jal-0x34-0x40"></a>
## 0x34-0x40, exactly 1 jal, no VU (wrapper w/ stack buffer / arg pack)

_41 total in this bucket; showing top 41._
...
_122 total in this bucket; showing top 50._
...
_26 total in this bucket; showing top 26._
...
| `func_0013F960` | 0x2C | 11 | 0 |  | `lw beqz addiu lw` | asm/cod/03F930.s:31 |
...
| `func_0017D0F8` | 0x30 | 12 | 0 |  | `beqz nop lw beqz` | asm/cod/07D0F8.s:13 |
...
_4148 unmatched functions are not in any shape bucket above._
