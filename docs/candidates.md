...
- Generated: 2026-05-14 19:31:13 UTC
...
- Functions: 4457 total in `asm/cod/*.s`, 226 parked, 4231 considered
...
|---|---:|---:|---:|:---:|---|---|
| `func_001E8EA8` | 0x10 | 4 | 0 |  | `lw lw j lw` | asm/cod/0E8EA8.s:13 |
...
| `func_001C3720` | 0x3C | 15 | 1 |  | `addiu addiu sd daddu` | asm/cod/0C3720.s:13 |
| `func_001F22E0` | 0x3C | 15 | 1 |  | `addiu addiu sd daddu` | asm/cod/0F22E0.s:13 |
| `func_0017E838` | 0x34 | 13 | 1 |  | `addiu sd daddu swc1` | asm/cod/07E838.s:13 |
| `func_0024DA80` | 0x38 | 14 | 1 |  | `addiu lui lui sd` | asm/cod/14DA80.s:13 |
...
| Function | Size | Insns | jal | VU | First mnemonics | Source |
|---|---:|---:|---:|:---:|---|---|
| `func_001B5958` | 0x3C | 15 | 2 |  | `addiu sd jal nop` | asm/cod/0B5958.s:13 |
...
| `func_0013A820` | 0x48 | 18 | 1 |  | `addiu addiu bne sd` | asm/cod/03A820.s:13 |
...
| `func_001E69D8` | 0xBC | 47 | 1 |  | `addiu addiu sd lui` | asm/cod/0E69D8.s:13 |
...
| `func_001ADBC0` | 0x54 | 21 | 1 |  | `addiu lui sd addiu` | asm/cod/0ADBC0.s:13 |
...
| `func_001AA4F0` | 0x60 | 24 | 2 |  | `addiu daddu sd lui` | asm/cod/0AA4F0.s:13 |
...
_4112 unmatched functions are not in any shape bucket above._
