/* libgcc.a member _divdi3.o.  MAIN.MAP member spans tile this run exactly and
...
extern const unsigned char D_00637A38[];
            ...
            for (__a = SI_TYPE_SIZE - 8; __a > 0; __a -= 8)                                        \
                if (((__xr >> __a) & 0xff) != 0)                                                   \
                    break;                                                                         \
                                                                                                   ...
                                                                                                   \
        (count) = SI_TYPE_SIZE - (D_00637A38[__xr >> __a] + __a);                                  \
    } while (0)
