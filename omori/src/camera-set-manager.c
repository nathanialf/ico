...
void func_0018A300(float *a0, int *a1, int *a2) {
    *a1 = 0;
    *a2 = 0;
    if (D_006C9FB0.f_30) {
        if (D_006C9FB0.f_31) {
        ...
        *a2 = 1;
        a0[0] = D_006C9FB0.f_10;
        a0[1] = D_006C9FB0.f_14;
        a0[2] = D_006C9FB0.f_18;
        a0[4] = D_006C9FB0.f_20;
        a0[5] = D_006C9FB0.f_24;
        a0[6] = D_006C9FB0.f_28;
    }
}
