...
void actDejaChk(volatile int a0) {
    ...
    func_00178DD8(0x144);
    debug_StdPrintfDummy(D_00614380);
    AdpcmClose(*(int *)(D_0062BBF4 + 0x2C));
    scpFadeOut(0, 0, 0, 4.0f);
    while (scpFadeChk() != 0) {
        _ACTWait(1);
    }
    RequestStageChange(1, D_00629DE4, 0, 255.0f, 16.0f);
}
...
void actDeja(volatile int a0) {
    ...
    iosThreadSetPri(D_0062C290 + 0x24, 0x22);
...
void func_00205BE8(volatile int a0) {
    ...
    if (func_00178DB0(0x147) == 0) {
        ...
        scpPlayPosSet((void *)D_00629DE8, -30.0f, -436.0f, -1.0f);
...
void func_00206FE0(volatile int a0) {
    ...
    }
    {
        ...
        stgmgrNextStagePreLoadForceStageSet(D_0055A2D8[s].f_24);
    }
...
void func_00207130(volatile int a0) {
    ...
    _ACTWait(1);
    if (func_00178DB0(0x147) == 0) {
        D_004CB6F0[1] = (int)actE3CageFallReadyChk;
