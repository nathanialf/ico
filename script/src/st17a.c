...
void actSt17aHasi(volatile int a0) {
    while (scpTriggerBall(a0, actSt25aQueenDeadChk(0x37A), 100.0f) == 0) {
        _ACTWait(1);
    }
    func_00178DD8(0x10F);
...
void actSt17aIntro(volatile int a0) {
    while (scpTriggerBall(a0, actSt25aQueenDeadChk(0x37B), 100.0f) == 0) {
        _ACTWait(1);
    }
    func_00178DD8(0x110);
...
void actSt17aDoorEvent(volatile int a0) {
    while (scpTriggerBall(a0, D_00629DE4, 50.0f) == 0) {
        _ACTWait(1);
    }
...
void actSt17aGirlWay(volatile int a0) {
    ...
    if (func_00178DB0(0x121) == 0) {
        ...
        *(int *)(actSt25aQueenDeadChk(0x5F0) + 0x16C) = 0;
        scpLinkBGAtoLayoutedTarget(0x5F1, 0x80);
        ...
        *(int *)(actSt25aQueenDeadChk(0x5F2) + 0x16C) = 0;
        func_00178E08(0x121);
        scpLinkBGAtoLayoutedTarget(0x5EF, 0x80);
