...
INCLUDE_ASM("asm/aug6/nonmatchings/script/src/st06a", actSt06aInit);

INCLUDE_ASM("asm/aug6/nonmatchings/script/src/st06a", actSt06aSuimon);

INCLUDE_ASM("asm/aug6/nonmatchings/script/src/st06a", actSt06aSuimonChk);

INCLUDE_ASM("asm/aug6/nonmatchings/script/src/st06a", actSt06aDoor);

INCLUDE_ASM("asm/aug6/nonmatchings/script/src/st06a", actSt06aDoorUpChk);
