...
INCLUDE_ASM("asm/aug6/nonmatchings/script/src/st22a", func_00230BF0);

INCLUDE_ASM("asm/aug6/nonmatchings/script/src/st22a", func_00230C00);
...
INCLUDE_ASM("asm/aug6/nonmatchings/script/src/st22a", func_00230F70);
