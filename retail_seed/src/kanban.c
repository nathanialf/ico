...
const char D_00616C90[24] = "no texture loaded.(%s)\n";

/* String rodata migrated from kanban_data.c */
const char D_00616CA8[24] = "src/kanban.c";

/* String rodata migrated from kanban_data.c */
const char D_00616CE0[16] = "sync end\n";

/* String rodata migrated from kanban_data.c */
const char D_00616CF0[16] = "unformatted %d\n";

/* String rodata migrated from kanban_data.c */
const char D_00616D00[32] = "not insert memory card %d\n";

/* String rodata migrated from kanban_data.c */
const char D_00616D20[24] = "%s file not found\n";

/* String rodata migrated from kanban_data.c */
const char D_00616D38[24] = "%s Directory not found\n";

/* String rodata migrated from kanban_data.c */
const char D_00616D50[48] = "segID %d check sum err rom:%d != load:%d\n";

/* String rodata migrated from kanban_data.c */
const char D_00616D80[32] = "%s handler func ret err code\n";

/* String rodata migrated from kanban_data.c */
const char D_00616DA0[16] = "memory over\n";
