...
extern int func_00261200(void *a0, void *a1, void *a2);
extern int func_002613B4(void *a0, void *a1);
...
void func_0019A3C8(void)
{
    ...
    int i;
    for (i = 0; i < 0x68; i++) {
        func_00261200(&D_005EBC68[i * 0x190], &D_0062C950, buf);
        D_006CDC20[i] = -1;
        {
            unsigned int j = 0;
            while (j < 0x23) {
                if (func_002613B4(buf, &D_00556920[j * 0x2C]) == 0) {
                    D_006CDC20[i] = j;
                    break;
                }
                j++;
