...
INCLUDE_ASM("asm/aug6/nonmatchings/fumi/src/way_util", visible_waypoint_of_all_except_gid_ThreadVersion);
...
INCLUDE_ASM("asm/aug6/nonmatchings/fumi/src/way_util", get_wp_nearest_bridge_side_me);
