...
extern volatile float D_00629734;
...
typedef struct { float x, y, z, w; } FVEC __attribute__((aligned(16)));
...
#define EnvAssistLoop(acc_, S_, dst_) { \
    ...
    char *w; \
    int i; \
    head = *(char **)(((union PFAlias *)((S_) + 0x15C))->p + 0x178); \
    (acc_)[0] = 0; \
    (acc_)[1] = 0; \
    (acc_)[2] = 0; \
    i = 3; \
...
void func_001FA3D0(void *arg0, void *arg1, char *arg2, void *arg3, void *arg4) {
    struct {
        AVEC v00, v01, v02;
    } __attribute__((aligned(16))) W;
    float w34;
    TI128 dv04, dv12, dv13, dv14, dv15, dv17, dv18;
...
#define FI_0x1D8 w1D8
    ...
    w20 = (char *)v02;
    func_001443B8(w20, (void *)FI(0x30), 0x2C);
    w20 = 0;
    {
...
L6B4:
        ...
        if (*(int *)(sub + 0x178) != 0) {
            ...
            *(float *)((char *)arg4 + 0xC) = 1.0f;
            if (s6 != 0) {
                ...
                {
                    char *wb = (char *)&f6C - 12;
                    func_001443B8(wb, (void *)FI(0x30), 0x2C);
    ...
    if (f22 != D_0062D9D8 && s6 != 0 && FI(0x1B4) != 0) {
        ...
        *(int *)arg3 |= 1;
        ...
        if (f22 < 50.0f) {
            ...
            if (stt == 0x11) {
                ...
                *(int *)((char *)arg4 + 0x140) = (int)box;
                if (GetBoxGlobalHoldPoint(box) == 0) goto L11g;
            ...
            if (stt == 0x18) {
                ...
                if (func_001BDF68(box) == 0) goto L18g;
        ...
        }
        {
            ...
            float thr;
            me0 = (char *)FI(0x30);
            mo2 = &D_0055DA10[*(int *)(*(char **)(me0 + 0x15C) + 0x490)];
            k = (*(int *)&mo2->u184 << 6) >> 30;
            switch (k) {
            case -1: {
                int r;
        ...
        if (f22 < 50.0f) {
            ...
            if (a < 0x28) {
                if ((char *)FI(0x30) == (char *)D_00629DE4 ||
                    ...
                    ((union LLAlias *)(env + 0x470))->ll |= 0x8000LL << 43;
                }
            }
        }
        ...
        }
        {
            ...
            if ((char *)FI(0x30) == (char *)D_00629DE4 && (char *)D_00629DE8 != 0 &&
                *(int *)(*(char **)((char *)D_00629DE8 + 0x164) + 0x30) != 0x26 &&
                ...
                FI(0x1CC) = 1; rootUpd = -EnableChangeRootUpdateMode((void *)D_00629DE4);
                if (!(f21 < 60.0f)) {
                    FI(0x1CC) = 0;
                }
                m = (char *)&f64 - 4;
                ...
                ccat = 0;
                f22 = D_0062D9D8;
                GetRootMatrixByDObj(m, (void *)D_00629DE4);
                w70 = (char *)&f74 - 4;
                ...
                if ((char *)D_00629DE8 != 0 && (char *)D_00629DE4 != 0) {
                    char *p1 = (char *)ContinueCorrectPosition((void *)D_00629DE8);
                    m = (char *)ContinueCorrectPosition((void *)D_00629DE4);
                    ...
                    *(float *)((char *)FP(0x80) + 0x34) = *(float *)((char *)FP(0x80) + 0x34) + f24;
                    ...
                    while (fnd != 0) {
                        if (*(int *)(fnd + 0x16C) != 0 && ExecBoxMoveEndReaction(fnd) != 7) {
                            ...
                            if (RotateAccordingToStick_PatternThree((int)pb, FP(0x100)) < D_00629738) {
                                d = FF(0xB4) - FF(0x104);
                ...
                if (ccat != 0 && f22 < rootUpd) {
                    if (EnvSlotDist(FI(0x1D4), FV(0x70)) < D_0062973C &&
                                      ...
                                      FP(0x160), FP(0x150));
                        {
                            ...
                            ((union IFAlias *)(q + 0x730))->f = *(float *)((char *)arg4 + 0x10);
                            *(int *)(q + 0x744) = 0x14;
                            {
                                char *q2 = (char *)*(int *)((char *)*(int *)(gq + 0x164) + 0x678);
                                *(float *)(q + 0x734) = *(float *)((char *)arg4 + 0x14);
                                ((union IFAlias *)(q + 0x738))->f = *(float *)((char *)arg4 + 0x18);
                                ((union IFAlias *)(q + 0x740))->f = 30.0f;
                                *(int *)(q2 + 0x748) = 0;
                            }
                        }
                        ...
                        if (FI(0x1CC) != 0) {
                            ...
                            *(int *)((char *)arg4 + 0x134) = ccat;
                            ...
                            switch (ccat) {
                            case 0x64:
                                v470 = *(long long *)(env + 0x470);
                                b470 = 0x8000LL << 47;
                            Lor470:
                                ((union LLAlias *)(env + 0x470))->ll = v470 | b470;
                                break;
                            case 0xC8:
                                b470 = 0x8000LL << 48;
                                v470 = *(long long *)(env + 0x470);
                    ...
                    if (func_00191D90(p80, (void *)FI(0x1C8)) < 0x50) {
                                ...
                                *pt = (int)D_004C6ED0;
                                ...
                                if (c16b == 1) {
                                    *pt = (int)D_004C6EE0;
                                    ...
                                    _OrientXZGV(FP(0xC0), D_004C6F10, tb);
                                    *pc = c16b;
                                } else {
                                    *pt = (int)D_004C6EF0;
                                    tb = D_004C6F30;
                                    ...
                                    _OrientXZGV(FP(0xC0), D_004C6F20, tb);
                                }
                                *pf = 1;
                            }
                        }
                        {
                            ...
                            for (idx = 0; 0.0f <= ((float *)FI(0x190))[idx]; idx++) {
                                if (func_001FA078((char *)FP(0x90), FP(0x10), (void *)FI(0x1C8),
    ...
    if (vw == (char *)D_00629DE4 &&
        ...
        if (w != 0) {
            ...
            *(int *)((char *)arg4 + 0x158) = (int)w;
            ...
            if ((func_00191D90(g90, (void *)FI(0x1A8)) < 0x2D &&
                 RotateAccordingToStick_PatternThree((int)w70, FP(0x10)) < 6400.0f) ||
                (func_00191D90(g90, (void *)FI(0x1A8)) >= 0x2D &&
    ...
    if ((unsigned int)e30 < 0x3B) {
        if ((unsigned int)e30 >= 0x39) {
            ...
            if (0.0f < FF(0x19C)) {
                ((union LLAlias *)(env + 0x470))->ll |= 0x8000LL << 36;
            } else {
    ...
    if (ForMotionViewer_GetCurrentAnimationFrame(FI(0x30), 0x800000)) {
        char *q2;
        pv = (char *)&f64 - 4;
        sceVu0Normalize(pv, *(char **)((char *)FI(0x30) + 0x15C) + 0x1C0);
    ...
    if (ForMotionViewer_GetCurrentAnimationFrame(FI(0x30), 0x50)) {
        *(long long *)(env + 0x470) |= 0x20;
        {
            float *wp = (float *)((char *)((union IFAlias *)((char *)FI(0x30) + 0x15C))->i + 0x634);
            float wv = *wp;
            if ((char *)FI(0x30) == (char *)D_00629DE4 ? (wv > 110.0f) : (wv > 135.0f)) {
    ...
    if ((char *)FI(0x30) == (char *)D_00629DE4) {
        ...
        if (t16 != 0) {
            ...
            if (lit == 0 &&
                RotateAccordingToStick_PatternThree((int)FP(0), wt) < D_0062975C &&
                FF(0x74) < FF(0x4)) {
                if (func_00192040(wt, FP(0), subCommonIdle((void *)FI(0x30)), 0x2D)) {
                    float d = FF(0x74) - FF(0x4);
                    if (d < 0.0f) {
