...
void _ScaleMatrixV(void *a0, void *a1, float *a2) {
    D_00272540[0] = a2[0];
    D_00272540[5] = a2[1];
    D_00272540[10] = a2[2];
    __asm__ __volatile__(
...
void _SetCameraMatrix(void *a0, void *a1, void *a2, void *a3) {
...
void _MakeLightColorMatrix(void *a0, void *a1, void *a2, void *a3, void *a4) {
    __asm__ __volatile__(
        ".set noreorder\n"
        "daddu $10, $6, $0\n"
        "daddu $3, $7, $0\n"
