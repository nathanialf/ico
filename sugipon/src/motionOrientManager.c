...
void shiftMotionOrientEndFunc(void *a0, int a1, void *a2) {
    ...
    case 0x0C: case 0x0D: case 0x0E: case 0x12: case 0x13:
        sprintf(buf, D_0062D5E0); break;
    case 0x01: sprintf(buf, D_0062D5E8); break;
    case 0x14: sprintf(buf, D_0062D5F0); break;
    case 0x02: sprintf(buf, D_00611F50); break;
    case 0x11: sprintf(buf, D_00611F60); break;
    case 0x07: sprintf(buf, D_00611F70); break;
    case 0x10: sprintf(buf, D_00611F88); break;
    case 0x08: sprintf(buf, D_00611FA0); break;
    case 0x09: sprintf(buf, D_00611FB8); break;
    case 0x0A: sprintf(buf, D_0062D5F8); break;
    case 0x0F: sprintf(buf, D_00611FC8); break;
    case 0x0B: sprintf(buf, D_0062D600); break;
    case 0x05: sprintf(buf, D_0062D608); break;
    case 0x04: sprintf(buf, D_0062D610); break;
    case 0x03: sprintf(buf, D_0062D618); break;
    case 0x00: sprintf(buf, D_00611FD8); break;
    case 0x06: sprintf(buf, D_00611FE8); break;
    }
    if (D_0062AFA8 != 0) {
        blk = *(ShiftBlk *)(D_005C8010 + a1 * 0x20);
        debug_PrintFontWindow(a2, D_00611FF8, &blk,
