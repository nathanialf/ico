...
extern void _FTOI4Vector(int *out, int *src);
...
void func_001D1ED8(char *a0, int a1) {
    if (*(int *)(a0 + 0xC) >= 0) {
        debug_StdPrintfDummy(D_00611958, D_00611990,
...
INCLUDE_ASM("asm/aug6/nonmatchings/sugipon/src/lodManager", InitMotionFile);
...
void AddMotionMemorySize(int a0, int a1) {
    if (a1)
        D_0062C210 += a0;
    else
        D_0062C20C += a0;
