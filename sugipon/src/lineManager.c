...
void func_001D15C0(int *a0, int *a1, int *a2, int a3) {
    gif_SetGsReg(0, D_0062B704);
    gif_SetGsReg(1, a2[0] | ((long long)a2[1] << 8) | ((long long)a2[2] << 16) | ((long long)a2[3] << 24));
    if (a3 == 0) {
        gif_SetGsReg(5, a0[0] | ((long long)a0[1] << 16) | ((long long)a0[2] << 32));
        gif_SetGsReg(5, a1[0] | ((long long)a1[1] << 16) | ((long long)a1[2] << 32));
    } else {
        gif_SetGsReg(5, a0[0] | ((long long)a0[1] << 16) | ((long long)a3 << 32));
        gif_SetGsReg(5, a1[0] | ((long long)a1[1] << 16) | ((long long)a3 << 32));
    }
}
