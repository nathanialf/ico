...
extern float _DistxzGV(int a0, int a1);
extern int fptodp(float f);
extern int dpmul(int a, long long b);
extern float dptofp(int a);
...
int subEnemyBrainMain(int self, int a1, int a2) {
    ...
    f22 = _DistxzGV(a2, ContinueCorrectPosition(a1));
