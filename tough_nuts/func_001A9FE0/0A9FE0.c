...
{
  int idx = D_00633E58;
  int *entry = (int *) (((char *) D_006F1EE0) + (idx * 0x1C));
 ...
 do { ((unsigned char *) entry)[0xD] = a1 >> 16; ((unsigned char *) entry)[0xE] = a1 >> 8; ((unsigned char *) entry)[0xF] = a1; *((unsigned short *) (((char *) entry) + 0x14)) = (unsigned short) mmio; } while (0);
    entry[0x10 / 4] = a2;
    entry[0x18 / 4] = a3;
  }
}
