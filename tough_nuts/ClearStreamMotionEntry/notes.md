...
**Seed:** `tough_nuts/ClearStreamMotionEntry/func_001F0878.c`

Disassembly:

```
.align 3
nonmatching ClearStreamMotionEntry, 0x5C

glabel ClearStreamMotionEntry
...
endlabel ClearStreamMotionEntry
```
