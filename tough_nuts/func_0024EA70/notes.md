# _sequenceHeader — parked

VRAM: 0x0024EA70 (file_off 0x14EA70)
Asm source: asm/aug6/nonmatchings/common/src/PObj/_sequenceHeader.s
...
**Seed:** `tough_nuts/_sequenceHeader/_sequenceHeader.c`

Disassembly:

```
.align 3
nonmatching _sequenceHeader, 0x154

glabel _sequenceHeader
    ...
    /* 14EA90 0024EA90 1C4A090C */  jal        _nextBit
...
.align 2
  .L0024EAE8:
    ...
    /* 14EB20 0024EB20 1C4A090C */  jal        _nextBit
    ...
    /* 14EB30 0024EB30 C448090C */  jal        _waitIpuIdle
    /* 14EB34 0024EB34 00000000 */   nop
    /* 14EB38 0024EB38 B848090C */  jal        _sendIpuCommand
    /* 14EB3C 0024EB3C 0050043C */   lui       $4, (0x50000000 >> 16)
    /* 14EB40 0024EB40 C448090C */  jal        _waitIpuIdle
...
.align 2
  .L0024EB64:
    ...
    /* 14EB74 0024EB74 C448090C */  jal        _waitIpuIdle
    /* 14EB78 0024EB78 00000000 */   nop
    /* 14EB7C 0024EB7C B848090C */  jal        _sendIpuCommand
    /* 14EB80 0024EB80 0058043C */   lui       $4, (0x58000000 >> 16)
    /* 14EB84 0024EB84 C448090C */  jal        _waitIpuIdle
...
.align 2
  .L0024EB94:
    ...
    /* 14EB9C 0024EB9C FE3B090C */  jal        _setDefaultQM
    /* 14EBA0 0024EBA0 40C8A524 */   addiu     $5, $5, %lo(D_0054C840)
.align 2
  .L0024EBA4:
    /* 14EBA4 0024EBA4 2A4B090C */  jal        _extensionAndUserData
