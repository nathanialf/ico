...
int _clipWWaveForce(void *a0, int a1, int a2) {
    int ret = 0;
    int i;
    ...
    for (i = 0; i < D_0062C01C; i++) {
        ...
        if (p != 0 && *p >= 0) {
            unsigned short v = *p;
            do {
                FzEntry *e = &D_0062C020->unk10[(short)v];
                if ((e->unk48 & 0xC0000000) == 0x40000000) {
                    if (__ClipFloor(a0, (int)e, 0, 1)) {
                        *(int *)((char *)a0 + 0x88) = (int)e;
                        ret = 1;
                        *(int *)((char *)a0 + 0x80) = a1;
                        *(int *)((char *)a0 + 0x84) = a2;
                    }
