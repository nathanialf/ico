...
extern void func_00186CA8(S4C *src, int count);
...
void func_00185BF8(M48 *src, M48 *dst) {
    ...
    *dst = *src;
    ...
    ang2 = MatrixDrive_GetTurnYAngleXZ(b40[0] * b40[0] + b40[1] * b40[1] + b40[2] * b40[2]);
...
extern int C_0062C048 __asm__("D_0062C048");
