...
**Reason parked:** init 3 floats; reg alloc differs (f2/f0/f1 vs f1/f2/f0); same shape as 23CCB8
...
**Reason parked:** float regalloc f1/f0 swap and store order differs from expected
...
**Reason parked:** near-miss: scheduler interleaves vs hoists float loads — same family as 23CCB8/23CA08
...
**Reason parked:** retry: scheduler order persistent — lwc1 hoisted before lw
...
**Reason parked:** ee-as reorders lw v1, addiu v0 and 2 swc1 stores
...
**Reason parked:** fno-schedule helps order but v0 vs v1 swap for self ptr
...
**Reason parked:** lwc1 scheduling hoists before lw v1; reg pin rv didn't help
