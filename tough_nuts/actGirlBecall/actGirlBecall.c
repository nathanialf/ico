...
extern int D_0028460C_v[] __asm__("D_0028460C");
typedef struct { char _0[0x4C]; int f_4C; } S557188;
extern S557188 D_00557188[];
extern char D_005598C8[];

int actGirlBecall(int a0, int a1) {
    float v[3];
    char *p;
    char *found;
    void *de8;
    ...
    if (D_00629DE4 == 0) goto ret0;
    if (D_00629DE8 == 0) goto ret0;
    idx = *(int *)((char *)(*(void **)((char *)D_00629DE8 + 0x164)) + 0x30);
    ent = (S557188 *)(idx * 0x50 + (char *)D_00557188);
    if (ent->f_4C & 1) {
        if (D_0028460C_v[0] == 1) ok = 1;
        else ok = 0;
    } else {
        ok = 0;
    }
    ...
    p = D_005598C8;
    do {
        if (*(int *)(p + 0xC) == a0 && *(int *)(p + 0x10) == a1) {
            found = p;
            goto searched;
        }
        p += 0x1C;
    } while ((int)p < (int)(D_005598C8 + 0xA10));
    found = 0;
searched:
    if (found != 0) {
        v[0] = -*(float *)(found + 0x0);
        v[1] = -*(float *)(found + 0x4);
        v[2] = -*(float *)(found + 0x8);
        r = ClearHandCameraCorrect(v, ContinueCorrectPosition(D_00629DE8));
        if (r < *(float *)(found + 0x14)) {
            de8 = D_00629DE8;
            v1 = *(void **)((char *)de8 + 0x164);
            dst = *(void **)((char *)v1 + 0x678);
            *(float *)((char *)dst + 0x330) = r * *(float *)(found + 0x18);
            return 1;
        }
        return 0;
    }
    s0 = ContinueCorrectPosition(D_00629DE4);
    f21 = _DistSqGV(s0, ContinueCorrectPosition(D_00629DE8));
    f20 = _ACTGame_GetParamF(5);
    f20 = f20 * _ACTGame_GetParamF(5);
    if (f21 < f20) return 1;
    return 0;
ret0:
    return 0;
