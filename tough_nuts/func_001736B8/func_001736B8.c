...
const char D_00632310[8] = "boy";
const char D_00632318[8] = "girl";
const char D_00632320[8] = "[%s]\n";
const char D_00632328[8] = "loop";
const char D_00632330[8] = "pull";
const char D_00632338[8] = "push";
int D_00632340 = 0x7F7FFFFF;
int D_00632344 = 0x00000000;
const char D_00632348[8] = "PICKUP";
const char D_00632350[8] = "ATTACK";
const char D_00632358[8] = "CLING";
const char D_00632360[] = "TO_GENE";
const char D_00632368[] = "TO_GIRL";
const char D_00632370[8] = "TO_BOY";
const char D_00632378[8] = "AWAIT";
const char D_00632380[8] = "IDLE";
const char D_00632388[8] = "START";
char D_00632508[8] = { 0 };
unsigned int D_00632510 = 0x00000078;
int D_00632DB4 = 0;
int D_00633060 = 0x00000001;
int D_00633064 = 0x00000000;
const char D_00633068[8] = "game.";
int D_00633070 = 0;
int D_00633074 = 0;
int D_00633078 = 0;
int D_0063307C = 0;
unsigned int D_00633080 = 0x00000001;
int D_00633084 = 0;
int D_00633088 = 0;
int D_0063308C = 0;
int D_00633090 = 0;
int D_00633094 = 0;
unsigned int D_00633098 = 0x00000001;
int D_0063309C = 0;
int D_006330A0 = 0;
int D_006330A4 = 0;
unsigned int D_006330A8 = 0xFFFFFFFF;
unsigned int D_006330AC = 0x00000001;
char D_006330B0[8] = { 0 };
char D_006330C8[8] = { 0 };
int D_006330E0 = 0;
int D_006330E4 = 0;
const char D_006330E8[8] = "fail\n";
int D_006330F0 = 0;
int D_006330F4 = 0;
int D_006330F8 = 0x20808080;
int D_006330FC = 0x00000000;
unsigned int D_00633100 = 0x2040FF40;
unsigned int D_00633104 = 0x00000001;
int D_00633108 = 0;
int D_0063310C = 0;
char D_00633110[8] = { 0 };
unsigned int D_00633118 = 0x000A6425;
int D_0063311C = 0;
int D_00633120 = 0;
int D_00633124 = 0;
int D_00633128 = 0;
...
void func_001736B8(int *out0, int *out1, int *out2, int *out3) {
    extern int *D_00631AE4;
    register int v0_in __asm__("$2");
    volatile int v0_spill;
    int *g;
    int *p164;
    int op;
    int merge_v;
    g = D_00631AE4;
    v0_spill = v0_in;
    __asm__ __volatile__("" :: "r"(out0) : "memory");
    p164 = (int *)g[0x164 / 4];
    *out0 = p164[0x30 / 4];
    *out1 = 0;
    *out2 = 0;
    *out3 = 0;
    ...
    switch (op) {
        ...
        case 3: {
            ...
            int local_v0;
            long long val;
            if (p164b[0x144 / 4] == 0) goto L_no_set;
            *out0 = 2;
L_no_set:
            p15C = (int *)g[0x15C / 4];
            {
                extern char D_00565060[];
                p = D_00565060 + p15C[0x4A0 / 4] * 0x190;
            }
            field = *(unsigned int *)(p + 0x184);
            top2 = field >> 30;
            switch (top2) {
                case 1: *out0 = 2; break;
                case 2: *out0 = 3; break;
            ...
            local_a0 = *out0;
            if (local_a0 != 3) goto L_BC;
            val = *(long long *)((char *)((int *)g[0x164 / 4])[0x678 / 4] + 0x408);
            if ((unsigned int)((unsigned long long)val >> 33) & 1) {
                local_v0 = 1;
                local_a0 = 1;
                goto L_B4;
            }
...
L_B4:
            *out0 = local_v0;
L_BC:
            if (local_a0 != 2) return;
            {
                register int *p678 __asm__("$4");
                p678 = (int *)((int *)g[0x164 / 4])[0x678 / 4];
                val = *(long long *)((char *)p678 + 0x408);
            }
            if ((unsigned int)((unsigned long long)val >> 33) & 1) {
                *out0 = 1;
            }
        ...
        case 54: {
            int *p164e = (int *)g[0x164 / 4];
            if (p164e[0x38 / 4] == 0x55) *out2 = 1;
            else *out3 = 1;
            return;
        }
        case 5:
