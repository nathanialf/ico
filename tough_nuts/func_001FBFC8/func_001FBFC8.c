...
const char D_0061AC70[16] = "src/EnemyInit.c";

/* String rodata migrated from EnemyInit_data.c */
const char D_0061AC80[16] = "isys:null GObj\n";
const char D_0061AC90[16] = "camera gop:%x\n";
const char D_0061ACA0[16] = "first entry\n";
const char D_0061ACB0[24] = "entry into head\n";
const char D_0061ACC8[24] = "entry into tail\n";
const char D_0061ACE0[24] = "LinkCameraDL in\n";
const char D_0061ACF8[24] = "LinkCameraDL out\n";
...
int *a0;
{
    ...
    prev = (int *)a0[0x34 / 4];
    if (next != 0) {
        next[0x34 / 4] = (int)prev;
    }
    if (a0[0x34 / 4] != 0) {
        ((int *)a0[0x34 / 4])[0x38 / 4] = a0[0x38 / 4];
    }
    if ((unsigned int)a0 == D_006321D4) {
        D_006321D4 = (unsigned int)a0[0x34 / 4];
    }
    if (a0 == D_006321D8) {
        D_006321D8 = (int *)a0[0x38 / 4];
    }
}
