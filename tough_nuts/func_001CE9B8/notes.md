...
**Reason parked:** reg alloc: zc in a2 vs expected a1; no separate count copy reg

Seed: `tough_nuts/func_001CE9B8/0CE9B8.c.new`
...
**Reason parked:** reg alloc zc/count swap a1/a2 (retry)
