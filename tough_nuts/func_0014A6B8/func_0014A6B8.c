...
struct E80_A6B8 { unsigned char pad[0x4C]; unsigned int f_4C; unsigned char pad2[0x10]; };
extern struct E80_A6B8 D_0055CFD8[];
int func_0014A6B8(int *a0)
{
    int *sub;
    if (a0 != D_00631AE4) goto fail;
    sub = (int *)a0[0x164 / 4];
    if (((D_0055CFD8[sub[0x30 / 4]].f_4C >> 9) & 1) == 0) goto fail;
    return sub[0x180 / 4];
fail:
    return 0;
}
