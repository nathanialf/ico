...
**Reason parked:** scheduling: lw a0,p15C moves before swc1 stores; sw zero,12(sp) in jal delay vs expected before lw a0
...
**Reason parked:** scheduler hoists lw a0 + addiu before swc1; target keeps them as jal arg prep + delay
