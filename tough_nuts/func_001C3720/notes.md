...
**Reason parked:** 1-insn diff: target has daddu v1,v0,zero copy of return reg; ee-gcc optimizes away
...
**Reason parked:** expected has daddu v1,v0,zero (dead copy) + sw s0,32(v1); mine uses v0 directly
