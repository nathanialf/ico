...
**Reason parked:** gcc folds 2 pointers into 1; expected has separate v0 and v1 pre-computed
...
**Reason parked:** reg alloc base in t0 vs v0; precompute slot offset order
