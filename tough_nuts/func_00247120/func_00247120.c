...
int sceSifSetIopAddr(int a0, void *a1, int a2) {
    ...
    *(int *)(D_0070F800 + 4) = a2;
    if (a2 == 0) {
        *(unsigned char *)(D_0070F800 + 8) = *(unsigned char *)a1;
    } else if (a2 == 1) {
        *(unsigned short *)(D_0070F800 + 8) = *(unsigned short *)a1;
    } else if (a2 == 2) {
        *(int *)(D_0070F800 + 8) = *(int *)a1;
    } else {
        return 0xFFFEFFFE;
    }
    r = sceSifCallRpc(D_0070FA00, 2, 0, D_0070F800, 0x20, D_0070F800, 0x10, 0, 0);
    return (r >= 0) ? 0 : 0xFFFEFFFF;
}
...
extern void __fpcmp_parts_d(void *a, void *b);
...
extern int __fpcmp_parts_f(void *a, void *b);
