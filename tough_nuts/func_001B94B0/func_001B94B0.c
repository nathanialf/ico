...
int func_001B94B0(int *self)
{
    ...
    _ApplyMatrix((int)&lA0, (int)&l60, (int)((char *)((GObj *)(self))->p_15C + 0x130));
...
void func_001BA090(int *self)
{
...

    {
        ...
        _MulMatrix(((int *)((GObj *)(self))->p_15C)[0xC / 4], (int)q1f0, (int)D_004BEE20);
    }
}
...
check:
    ...
    }
    {
        ...
        _ApplyMatrix((int)((char *)sub + 0x130), (int)((char *)q + 0x230), a2);
    }
    return 1;
ret0:
    return 0;
