...
**Reason parked:** Permuter cracked rc17->rc15 via inline (*(char**)(self+0x15C)) re-derivation (skips obj reuse) + duplicate v2 access via direct deref. Updated seed adopts permuter form for next 30-stall hand loop.

**TU:** `src/act-parallel-control.c`

**Seed:** `tough_nuts/func_0014B430/func_0014B430.2.c`
...
**Reason parked:** rc3 (was rc15 parked). cracked rc5->3 via fcc_nop @func_0014B430 scoped. uninit obj+pin idx2 REG("$3")+new_var/new_var2 volatile thresh. Floor: a1 vs a2 obj base (init obj regresses, all pin sweeps confirm)+missing daddu a1,a2 (bc1f delay)+missing nop@cvt.s.w. Tried 30 distinct hyps incl init obj sweeps, obj_copy pinning at multiple scopes, MEM_BARRIER, MATERIALIZE/ANCHOR, struct array index, char**pp intermediate, inline asm.

**TU:** `src/act-parallel-control.c`

**Seed:** `tough_nuts/func_0014B430/func_0014B430.3.c`
