...
void func_0015F578(int *self)
{
 ...
 do { new_var = ((struct U64 *) D_00282660)->v; p = (int *) self[0x15C / 4]; ((struct U64 *) (((char *) p) + 0x1C0))->v = new_var; *((int *) (((char *) p) + 0x1C8)) = *((int *) (D_00282660 + 8)); func_00158960(self, 0); } while (0);
}
