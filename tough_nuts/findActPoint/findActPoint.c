...
void findActPoint(void) {
    int *p = (int *)D_0062C234;
    float f = 3.402823466e+38f;

    p[0x104 / 4] = 0;
    p[0xF8 / 4] = 0;
    p[0x14 / 4] = ((p[0x14 / 4] &= 0xFFFFFFEF) & 0xFFFFFFDF) & 0xFFFFEFFF;
    p[0xFC / 4] = 0;
    p[0x100 / 4] = 0;
    *(int *)((char *)D_0062C230 + 0x134) = 0;
    *(float *)((char *)p + 0x170) = f;
    p[0x1B8 / 4] = p[0x1B4 / 4];
    p[0x1CC / 4] = 0;
    *(float *)((char *)p + 0x110) = f;
    *(float *)((char *)p + 0x114) = f;
    p[0xF4 / 4] = 0;
    *(float *)((char *)p + 0x138) = f;
    *(float *)((char *)p + 0x130) = f;
    *(float *)((char *)p + 0x134) = f;
    p[0x10C / 4] = 0;
    *(float *)((char *)p + 0x174) = f;
    p[0x178 / 4] = 0;
    p[0x108 / 4] = 0;
    p[0x1B4 / 4] = 0;
    p[0x1D4 / 4] = 0;
