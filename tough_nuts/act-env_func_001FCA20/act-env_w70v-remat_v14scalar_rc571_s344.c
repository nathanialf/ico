...
extern void GetRootProjectionPosOfGObj(void *a0, void *a1);
...
#define EnvAssistLoop(acc_, S_, dst_) { \
    ...
    w = head; \
    do { \
        sceVu0AddVector((acc_), (acc_), (float *)w); \
        w += 0x10; \
        i--; \
    } while (i >= 0); \
    sceVu0ScaleVector((float *)(dst_), (acc_), 0.25f); \
}

#define EnvAssistTail(tmp_, anch_, dst_, ascale_) { \
    sceVu0ScaleVector((tmp_), (float *)(anch_), (ascale_)); \
    sceVu0AddVector((float *)(dst_), (float *)(dst_), (tmp_)); \
}
...
void func_001FCA20(void *arg0, void *arg1, char *arg2, void *arg3, void *arg4) {
    ...
    TI128 dv15, dv17, dv18, dv19, dv1A;
...
#define v15 (*(AVEC *)&dv15)
#define v17 (*(AVEC *)&dv17)
...
#define FF_0x68  f68
#define FI_0x68  f68
#define FV_0x70  ((float *)&f70)
#define FP_0x70  ((void *)&f70)
#define FF_0x70  f70
#define FI_0x70  f70
#define FF_0x74  f74
#define FI_0x74  f74
...
#define FI_0x1D8 w1D8
    ...
    GetRootProjectionPosOfGObj(FP(0), (void *)FI(0x30));
    {
        char *p10 = (char *)FP(0x10);
        FI(0x1C4) = (int)p10;
        GetRootPosition(p10, (void *)FI(0x30));
    }
    w20 = (char *)v02;
    wPtr20 = (int)w20;
    ...
    f20 = D_0063144C;
    {
        ...
        for (;; found = isysGObjSearchFromObjKindID_next(found)) {
            ...
            CageFixDL(cagem, (char *)&f50, found);
            {
...
L6B4:
            ...
            *(float *)((char *)arg4 + 0xC) = 1.0f;
            if (s6 != 0) {
                ...
                }
                {
                    ...
                    ret = EnvCamAngle(wb, arg4, FP(0x70), -1.0f);
                }
                if (f18 != 0 && ret >= 0x1F) {
                    *(int *)arg3 |= 0x10;
                }
    ...
    if (f22 != D_00633850_[0] && s6 != 0 && FI(0x1B4) != 0) {
        ...
        wAang = EnvCamAngle(st, arg4, FP(0x60), -1.0f);
        if (wAang < 0) wAang = -wAang;
        ...
        *(int *)arg3 |= 1;
                ...
                if (ACTEnvGetTest()) {
                    ...
                    if (*(float *)(p2 + 4) + 50.0f < *(float *)(p1 + 4)) {
                        ...
                        _OrientGV(m90a, t80v);
                        {
                            ...
                            FI(0x7C) = 0;
                            sceVu0ApplyMatrix(FP(0x80), m90a, w70);
                        }
                        if (f22 < FF(0x88)) {
        ...
        }
        {
            gb = (char *)FI(0x30);
            {
                ...
                *(int *)(env + 0x174) = *(int *)((char *)((union IFAlias *)(gb + 0x15C))->i + 0x5E4);
                if (f22 < c40) {
        ...
        if (f22 < 120.0f && b6 != 0) {
            char *q;
            w60 = (char *)&f68 - 8;
            sceVu0ScaleVector(w60, arg4, f22);
            sceVu0AddVector(*(char **)(*(char **)((char *)FI(0x30) + 0x164) + 0x678) + 0x770,
                          (void *)FI(0x1C4), w60);
            sceVu0ScaleVector(*(char **)(*(char **)((char *)FI(0x30) + 0x164) + 0x678) + 0x780,
                          arg4, -1.0f);
            gb = (char *)FI(0x30);
        ...
        if ((char *)FI(0x30) == (char *)D_00631AE8) {
            if (func_0014B2F0((void *)FI(0x30), 0x1A)) {
                ...
                FI(0x64) = 0;
                if (sceVu0InnerProduct(g90, subCommonIdle((void *)D_00631AE4)) < 100.0f) {
                    int v5 = 0;
                    if (*(int *)(boxp + 0xC) == 0x11) {
        ...
        if (f22 < 50.0f &&
            ...
            if (stt == 0x10) {
                ...
                w70 = (char *)&f74 - 4;
                ((union LLAlias *)FP(0x70))->ll = *(long long *)&D_0061AD10[0];
            ...
            if (stt == 0x11) {
                ...
                *(int *)((char *)arg4 + 0x140) = (int)box;
                ...
                if (moveBoxAutoMatic(FP(0x70), box, (void *)FI(0x30)) == 0) goto L11m;
            ...
            if (stt == 0x16) {
                ...
                *(int *)((char *)arg4 + 0x14C) = (int)box;
                ...
                sceVu0ScaleVector(FV(0x70), (float *)arg4, -10.0f);
                func_001945B8(FV(0x70), D_00631450);
                sceVu0AddVector((float *)((char *)arg4 + 0xF0), (float *)((char *)arg4 + 0xF0), FV(0x70));
                stt = *(int *)(box + 0xC);
                goto L16d;
            L16e:
                stt = *(int *)(box + 0xC);
        ...
        if (f22 < 200.0f) {
            ...
            if (EnableMotionOrientUpdate__p4(FI(0x30), 0x400)) {
                ...
                *(float *)((char *)arg4 + 0xA8) = *(float *)((char *)arg4 + 0x8);
                EnvPushAvg(FV(0x70), (void *)FI(0x30), dstc, 0x188);
                sceVu0ScaleVector((float *)w70, (float *)arg4, 30.0f);
                sceVu0AddVector((float *)dstc, (float *)dstc, (float *)w70);
            ...
            case -1: {
                ...
                if (r & 0xFF) {
                ...
                } else {
                    {
                        ...
                        thr = GetCorrectDistance(wAang, ((MotionEntry *)mp)->f17C + 2.0f);
                    }
                }
                        ...
                        *(int *)((char *)arg3 + 8) = v;
                        if (((unsigned int)v >> 13) & 1) {
                            ...
                            if (S16 == (char *)D_00631AE4 &&
                                ...
                                {
                                    int r;
                                    { char *pd = (char *)&fD0; memset(pd, 0, 0xC0); pd = 0; }
        ...
        if (*(int *)((char *)FI(0x30) + 0xC) == 4) {
            if (*(int *)(*(char **)(*(char **)((char *)FI(0x30) + 0x164) + 0x670) + 0x1DC) == 3) {
                if (f22 < 180.0f) {
                    if (*(int *)(*(char **)((char *)FI(0x30) + 0x15C) + 0x1E4) != 0) {
    ...
    if (f21 != D_00633850_[0] &&
        (mm = (char *)FI(0x30), *(int *)(*(char **)(mm + 0x15C) + 0x558) != 0) &&
        FI(0x1B8) != 0) {
        void *st;
        int a;
        {
        ...
        *(float *)((char *)arg4 + 0x1C) = 1.0f;
        ...
        if ((char *)FI(0x30) == (char *)D_00631AE4 && (char *)D_00631AE8 != 0) {
            ...
            pp2 = (char *)ContinueCorrectPosition((void *)D_00631AE8);
            FF(0x68) = *(float *)(pp2 + 8);
            d2 = _DistSqGV((void *)FI(0x1C4), FP(0x60));
            rowf = ((CamEntry *)((char *)D_005F2FB8 + D_00631990 * 0x194))->f180;
            if (d2 < rowf * rowf) {
                sceVu0SubVector(FP(0xB0), FP(0x60), FP(0x10));
                _OrientGV(FP(0x70), (void *)FI(0x1C8));
                ((union IFAlias *)&fBC)->i = 0;
                sceVu0ApplyMatrix(FP(0xC0), FP(0x70), FP(0xB0));
                if (0.0f < FF(0xC8)) {
                    wFlag = 1;
                }
            }
        ...
        case 2:
            if (f21 < 20.0f && f24 > 180.0f) {
                ...
                {
                char *rmv = (char *)&f74 - 4;
                GetRootPosition(rmv, (void *)FI(0x30));
                sceVu0AddVector((char *)arg4 + 0x40, rmv, g90);
                }
                if (f21 > f20) {
                    if (ForMotionViewer_GetCurrentAnimationFrame(FI(0x30), 0xF000)) {
                        if ((float)a > 20.0f) {
                            ...
                            sceVu0ScaleVector(g90, (void *)FI(0x1C8), -v2);
                            {
                                ...
                                sceVu0AddVector((float *)pv, p, g90);
                            }
                            {
                                int vv;
        ...
        }
        {
            ...
            if ((char *)FI(0x30) == (char *)D_00631AE4 && (char *)D_00631AE8 != 0 &&
                *(int *)(*(char **)((char *)D_00631AE8 + 0x164) + 0x30) != 0x26 &&
                ...
                ccat = 0;
                f22 = D_00633850_[0];
                GetRootPosition(m, (void *)D_00631AE4);
                w70 = (char *)&f74 - 4;
                GetRootPosition(w70, (void *)D_00631AE8);
                w70s = (char *)&f74 - 4;
                if (!(f24 < 55.0f)) {
                    if (f24 < 155.0f) {
                        f22 = 80.0f;
                ...
                if (D_00631990 == 7) {
                    GetRootProjectionPosOfGObj(FP(0x80), (void *)D_00631AE8);
                    if (ccat == 0xC8) {
                ...
                if (!(ccat < 0xC8)) {
                    ...
                    pb = (char *)&fB0;
                    sceVu0AddVector((float *)pb, FP(0xA0), g90);
                ...
                if (ccat != 0 && f22 < rootUpd) {
                    if (FI(0x1D0) != 0) {
                        ...
                        q = (char *)*(int *)(q + 4);
                        g90 = (char *)FP(0x140);
                        GetRootPosition(g90, (void *)FI(0x30));
                        pv = (char *)FP(0x130);
                        sceVu0ScaleVector(pv, (void *)FI(0x1C8), f21);
                        sceVu0AddVector((char *)arg4 + 0x50, g90, pv);
                        q = (char *)&dv15;
                        q = (char *)*(int *)(q + 4);
                        g90 = (char *)FP(0x160);
                        ...
                        GetRootPosition(g90, (void *)FI(0x30));
                        pv = (char *)FP(0x150);
                        sceVu0ScaleVector(pv, (void *)FI(0x1C8), f21 - 30.0f);
                        sceVu0AddVector(*(char **)(*(char **)((char *)FI(0x30) + 0x164) + 0x678) + 0x740,
                                      FP(0x160), FP(0x150));
                        {
                        ...
                        if (FI(0x1CC) != 0) {
                            ...
                            *(int *)((char *)arg4 + 0x134) = ccat;
                            ...
                            default:
                                ...
                                __assert(D_0061AE10, 0x978, D_00633840);
                                break;
                            }
                            }
                        }
                                      ...
                                      FP(0x160), FP(0x170), (void *)&FI(0x198));
                        {
                            ...
                            for (idx = 0; 0.0f <= ((float *)FI(0x190))[idx]; idx++) {
                                if (func_001FC6C8((char *)FP(0x140), FP(0x10), (void *)FI(0x1C8),
                                    ...
                                    sceVu0ScaleVector(FP(0x150), ca, -1.0f);
                                    if (FI(0x194) != 0) {
                                        w140 = ((union IFAlias *)&w160)->f;
                                        w144 = ((union IFAlias *)&w164)->f;
                                        w148 = ((union IFAlias *)&w168)->f;
                                        v15[0] = v17[0];
                                        v15[1] = v17[1];
                                        v15[2] = v17[2];
                                    }
                                    if (f21 < 60.0f) {
                                        ...
                                        *(float *)((char *)arg4 + 0x60) = w140;
                                        *(float *)((char *)arg4 + 0x64) = w144;
                                        *(float *)((char *)arg4 + 0x68) = w148;
                                        *(float *)((char *)arg4 + 0x70) = v15[0];
                                        *(float *)((char *)arg4 + 0x74) = v15[1];
                                        *(float *)((char *)arg4 + 0x78) = v15[2];
                                        ((union LLAlias *)(env + 0x478))->ll |= 0x10;
                                    } else {
                                        char *q;
                                        sceVu0ScaleVector(FP(0x180), ca, f21 - 30.0f);
                                        sceVu0AddVector(*(char **)(*(char **)((char *)FI(0x30) + 0x164) + 0x678) + 0x7A0,
                                                      FP(0x10), FP(0x180));
                                        {
    ...
    Lchainbody:
        {
            ...
            char *pp;
            hit = 0;
            w140 = *(float *)((char *)arg4 + 0x10);
            w144 = *(float *)((char *)arg4 + 0x14);
            w148 = *(float *)((char *)arg4 + 0x18);
            ...
            if (fnd3 != 0) {
                ...
                if (*(int *)(fnd3 + 0x16C) != 0) {
                    ...
                    GetRootPosition(FP(0x170), fnd3);
                    if (!(func_00194590(FP(0x170), (void *)FI(0x1C8)) < 0x2E)) goto Lnext3;
                    GetRootPosition(g90, fnd3);
                    sceVu0SubVector(w70, g90, FP(0));
                    d20 = sceVu0InnerProduct(w70, FP(0x140));
            ...
            *(int *)((char *)arg4 + 0x15C) = (int)hit;
            ...
            pp = (char *)ContinueCorrectPosition(hit);
            v1A[2] = *(float *)(pp + 8);
            sceVu0ScaleVector((void *)v19, (void *)FI(0x1C8), -20.0f);
    ...
    if (ForMotionViewer_GetCurrentAnimationFrame(FI(0x30), 0x40)) {
        ...
        debug_StdPrintfDummy(D_00633848);
    }
        ...
        *(long long *)(env + 0x470) |= 0x20;
        {
            ...
            if ((char *)FI(0x30) == (char *)D_00631AE4 ? (wv > 110.0f) : (wv > 135.0f)) {
                ...
                debug_StdPrintfDummy(D_0061AE20);
            }
        }
        {
            ...
            if ((char *)FI(0x30) == (char *)D_00631AE4 ? (*wp < 105.0f) : (*wp < 130.0f)) {
                ...
                debug_StdPrintfDummy(D_0061AE30);
            }
        }
    }
    if ((char *)FI(0x30) == (char *)D_00631AE4) {
        ...
        float rad = 90.0f;
        {
            MotionEntry *mo3 = &D_00565060[*(int *)(*(char **)((char *)FI(0x30) + 0x15C) + 0x490)];
            if (mo3->u186 & 7) {
                rad = 100.0f;
            }
        }
        ...
        if (t16 != 0) {
            ...
            if (lit == 0 &&
                ...
                Lct2:
                    if (FF(0x74) < FF(0x4)) {
                        t22v = t16;
                        _OrientXZGV((char *)arg4 + 0x30, wt, FP(0));
