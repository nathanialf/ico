...
L6B4:
    ...
    if (f21 != D_00633850_[0] &&
        ...
        *(float *)((char *)arg4 + 0x1C) = 1.0f;
        ...
        if ((char *)FI(0x30) == (char *)D_00631AE4 && (char *)D_00631AE8 != 0) {
            ...
            FF(0x68) = *(float *)(pp2 + 8);
            w60 = (char *)&f6C - 12;
            d2 = _DistSqGV((void *)FI(0x1C4), w60);
            rowf = ((CamEntry *)((char *)D_005F2FB8 + D_00631990 * 0x194))->f180;
            if (d2 < rowf * rowf) {
                sceVu0SubVector(FP(0xB0), w60, (char *)&f50 - 0x40);
                w70 = (char *)&f74 - 4;
                _OrientGV(w70, (void *)FI(0x1C8));
                ((union IFAlias *)&fBC)->i = 0;
                sceVu0ApplyMatrix(FP(0xC0), w70, FP(0xB0));
                if (0.0f < FF(0xC8)) {
                    wFlag = 1;
                }
            }
    ...
    Lchainbody:
        {
            ...
            *(float *)((char *)&dv1A + 0) = *(float *)(pp + 0);
            pp = (char *)ContinueCorrectPosition(hit);
            *(float *)((char *)&dv1A + 4) = *(float *)(pp + 4);
            pp = (char *)ContinueCorrectPosition(hit);
            *(float *)((char *)&dv1A + 8) = *(float *)(pp + 8);
    ...
    {
    char *v1b = (char *)FI(0x30);
    if (v1b == (char *)D_00631AE4 && (char *)D_00631AE8 != 0) {
