...
#define EnvAssistTail(tmp_, anch_, dst_, ascale_) { \
    ...
    sceVu0AddVector((float *)(dst_), (float *)(dst_), (float *)&f70); \
}
        ...
        *(int *)arg3 |= 1;
        ...
        if (f22 < f20 && s18 != 0) {
            ...
            if (ll & 0x7800) {
                if ((int)(ll >> 13) & 1 && *(int *)((char *)FI(0x30) + 0xC) == 4) {
                    EnvPushPlane((float *)&f70, FV(0x80), (void *)FI(0x30), env, arg4, -20.0f, f22);
                } else {
                    EnvPushPlane((float *)&f70, FV(0x80), (void *)FI(0x30), env, arg4, 5.0f, f22);
                }
            }
        ...
        }
        {
            ...
            if (f22 < thr) {
                ...
                c60_100 = 0;
                if (60.0f < FF(0x34)) {
                    if (a34 < 100.0f) c60_100 = 1;
                }
                c60_150 = 0;
                if (60.0f < FF(0x34)) {
                    if (a34 < 150.0f) c60_150 = 1;
                }
                c60_230 = 0;
                if (60.0f < FF(0x34)) {
                    if (a34 < 230.0f) c60_230 = 1;
                }
        ...
        *(float *)((char *)arg4 + 0x1C) = 1.0f;
        ...
        if ((char *)FI(0x30) == (char *)D_00631AE4 && (char *)D_00631AE8 != 0) {
            ...
            if (d2 < rowf * rowf) {
                ...
                sceVu0ApplyMatrix(FP(0xC0), (void *)&f70, FP(0xB0));
                if (0.0f < FF(0xC8)) {
                    wFlag = 1;
                }
            }
