                ...
                *(float *)((char *)arg4 + 0xA8) = *(float *)((char *)arg4 + 0x8);
                {
                    ...
                    w = head;
                    do {
                        func_00243AD0((float *)w70, (float *)w70, (float *)w);
                        w += 0x10;
                        i--;
                    } while (i >= 0);
                    func_00243B18((float *)dstc, (float *)w70, 0.25f);
                }
                ...
                *(int *)(*(char **)((char *)D_00631AE8 + 0x164) + 0x30) != 0x26 &&
                ...
                if (ccat != 0 && f22 < rootUpd) {
                    if (FI(0x1D0) != 0) {
                        ...
                        func_00243AD0((char *)arg4 + 0x50, gI, pv);
                        q = (char *)&w150;
                        q = (char *)*(int *)(q + 4);
    ...
    Lchainbody:
        {
            ...
            *(int *)((char *)arg4 + 0x15C) = (int)hit;
            ...
            pp = (char *)ContinueCorrectPosition(hit);
            y1A8 = *(float *)(pp + 8);
            func_00243B18((void *)&dv19, (void *)FI(0x1C8), -20.0f);
