...
#define EnvAssistTail(tmp_, anch_, dst_, ascale_) { \
    ...
    func_00243AD0((float *)(dst_), (float *)(dst_), (tmp_)); \
}
...
void func_001FCA20(void *arg0, void *arg1, char *arg2, void *arg3, void *arg4) {
    ...
    float w34;
    TI128 dv04, dv12, dv13, dv14, dv15, dv17, dv18, dv19, dv1A;
        ...
        if (f22 < 50.0f &&
            ...
            if (stt == 0x16) {
                ...
                *(int *)((char *)arg4 + 0x14C) = (int)box;
                ...
                func_00243AD0((float *)((char *)arg4 + 0xF0), (float *)((char *)arg4 + 0xF0), FV(0x70));
                stt = *(int *)(box + 0xC);
                goto L16d;
            L16e:
                stt = *(int *)(box + 0xC);
    ...
    if (f21 != D_00633850_[0] &&
        ...
        *(float *)((char *)arg4 + 0x1C) = 1.0f;
        ...
        if ((char *)FI(0x30) == (char *)D_00631AE4 && (char *)D_00631AE8 != 0) {
            ...
            pp2 = (char *)ContinueCorrectPosition((void *)D_00631AE8);
            FF(0x68) = *(float *)(pp2 + 8);
            d2 = HandyCamera_TargetMoveType((void *)FI(0x1C4), FP(0x60));
            rowf = ((CamEntry *)((char *)D_005F2FB8 + D_00631990 * 0x194))->f180;
            if (d2 < rowf * rowf) {
                func_00243AE8(FP(0xB0), FP(0x60), FP(0x10));
                _OrientGV(FP(0x70), (void *)FI(0x1C8));
                ((union IFAlias *)&fBC)->i = 0;
                func_002438B8(FP(0xC0), FP(0x70), FP(0xB0));
                if (0.0f < FF(0xC8)) {
                    wFlag = 1;
                }
            }
                                      ...
                                      FP(0x160), FP(0x170), (void *)&FI(0x198));
                        {
                            ...
                            for (idx = 0; 0.0f <= ((float *)FI(0x190))[idx]; idx++) {
                                if (func_001FC6C8((char *)FP(0x140), FP(0x10), (void *)FI(0x1C8),
                                    ...
                                    if (FI(0x194) != 0) {
                                        v14[0] = ((union IFAlias *)&w160)->f;
                                        v14[1] = ((union IFAlias *)&w164)->f;
                                        v14[2] = ((union IFAlias *)&w168)->f;
                                        v15[0] = v17[0];
                                        v15[1] = v17[1];
                                        v15[2] = v17[2];
                                    }
                                    if (f21 < 60.0f) {
                                        ...
                                        *(float *)((char *)arg4 + 0x60) = v14[0];
                                        *(float *)((char *)arg4 + 0x64) = v14[1];
                                        *(float *)((char *)arg4 + 0x68) = v14[2];
    ...
    Lchainbody:
        {
            ...
            p90 = (char *)FP(0x140);
            hit = 0;
            v14[0] = *(float *)((char *)arg4 + 0x10);
            v14[1] = *(float *)((char *)arg4 + 0x14);
            v14[2] = *(float *)((char *)arg4 + 0x18);
            func_001945B8(p90, D_00631468);
