 ...
 * `__assert(file, line, D_006321B8)`; in the original ELF those
...
extern void StartThread(int a0, int a1);
...
extern void SleepThread(int a0, int a1, int a2, int a3);
...
{
    int *obj = (int *) D_006A6F30[GetThreadId()];
    if (obj[0x48 / 4] == 0)
    {
        int m;
        register int v = 1;
...
extern void SuspendThread(int a0);
...
extern void ResumeThread(int a0);
...
void func_0013D928(int *self) {
    WakeupThread(self[12]);  // 0x30/4 = 12
    DEFEAT_TCO();
}
...
int func_0013DA00(int *self, int a1, int a2, int a3)
{
    ...
    if (rv < 0) {
        ...
        __assert(D_005578D0, 0x25C, D_006321B8);
        return self[0x30 / 4];
    }
    return 0;
}
...
int func_0013DA88(int *self)
{
    ...
    if (rv < 0) {
        ...
        __assert(D_005578D0, 0x270, D_006321B8);
        return rv;
    }
    return 0;
}
...
int func_0013DBB0(int *self)
{
    ...
    if (rv < 0) {
        ...
        __assert(D_005578D0, 0x2B0, D_006321B8);
        return rv;
    }
    return 0;
}
