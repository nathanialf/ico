...
**Reason parked:** fails to emit bnel pattern; built uses regular beq with fail-first layout, target uses bnel with body-hoisted lw in delay
...
**Reason parked:** near-miss: gcc emits beq+full else-block; expected uses bnel branch-likely with annulled delay-slot deref
