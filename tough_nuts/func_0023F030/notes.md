...
**Reason parked:** ee-as places sw v0 between zero stores instead of before; gcc store ordering
...
**Reason parked:** sw v0 placement between ld s0 and sw zero (ee-as)
...
**Reason parked:** near-miss: sw v0,gp_rel(D_88) scheduled after ld s0 instead of before
