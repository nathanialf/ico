...
Seed: `tough_nuts/stageSE13cNoise/13CCB8.c`

Disassembly excerpt:

```
(no asm/cod/*.s found for stageSE13cNoise; check asm/matchings/cod/13CCB8/)
```
...
Seed: `tough_nuts/stageSE13cNoise/13CCB8.c.new`

Disassembly excerpt:

```
glabel stageSE13cNoise
