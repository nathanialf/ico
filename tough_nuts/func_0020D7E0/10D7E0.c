...
void func_0020D7E0(int unused)
{
    ...
    if (D_00633918 != 0) {
        func_0017D0D0(D_00633918, 0x50);
    }
    func_0017E330(1, D_00631AE4, 0, 16.0f, D_006314E4);
}
