...
func_00265168(name,buf); sprintf(namebuf,D_00631F70,name); normalise namebuf
(D_0062FC79 idiom); func_00265168(name,namebuf); clear self[0x158..0x15A],
self[0x24]=0; if(func_0024D120(1)!=2){ copy "SCUS_971.13"(D_005567F0) into disk;
func_00133218(disk); do{printf("wait insert");func_0024D120(0);}
while(func_0024D718()!=0x12 || func_0024C6B8(namebuf,disk)==0); }
self[0xC]=0; func_001312F0(self); size=self[0x138];
self[0x2C]=((unsigned)(size-1)>>11)+1; got=func_00135EB8(0x120010,"ios/cdvd.c",
0x85C); self[0x160]=got; self[0x164]=(got+0xF)&~0xF; func_0024D9B8(0x240,0x24,
rounded); func_0024D9E8(self[0x134], self+0x158); self[0x8180]=self[0x138].
...
HEAVY register reuse the dev's lifetimes produced:
  $16 = namebuf loop-cursor (sp+0x100, spans the func_00264DF8 call)
  $17 = self        $18 = name (self+0x34) -> REUSED for %hi(D_00556800)
  $19 = name copy -> REUSED for self+0x158 (func_0024D9E8 arg)
