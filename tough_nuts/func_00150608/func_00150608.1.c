...
int func_00150608(void) {
    ...
    sceVu0SubVector(buf, r1, r2);
    if (0.0f < sceVu0InnerProduct(buf, s1 + 0x4B0)) {
        if (_DistxzGV(s1 + 0x4F0, ContinueCorrectPosition(D_00629DE8)) < 100.0f) {
            if ((((long long)(int)*(unsigned short *)(*(char **)((char *)D_00629DE8 + 0x164) + 0x1E)) & 1) != 0) {
