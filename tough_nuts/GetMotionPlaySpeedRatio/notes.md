# getFinalMatrixCore — parked

VRAM: 0x001DDD28 (file_off 0x0DDD28)
Asm source: asm/aug6/nonmatchings/sugipon/src/motionOrientManager/getFinalMatrixCore.s
...
**Seed:** `tough_nuts/getFinalMatrixCore/getFinalMatrixCore.c`

Disassembly:

```
.align 3
nonmatching getFinalMatrixCore, 0xE0

glabel getFinalMatrixCore
...
.align 2
  .L001DDD48:
    ...
    /* DDD54 001DDD54 1614040C */  jal        MatrixDrive_PushMatrixWithNoCopy
    /* DDD58 001DDD58 21985100 */   addu      $19, $2, $17
    /* DDD5C 001DDD5C 9837040C */  jal        PushQuaternionWithNoCopy
    ...
    /* DDD84 001DDD84 4817040C */  jal        CopyMatrix
    ...
    /* DDDB4 001DDDB4 4A77070C */  jal        getFinalMatrixCore
    /* DDDB8 001DDDB8 00000000 */   nop
.align 2
  .L001DDDBC:
    /* DDDBC 001DDDBC 1A14040C */  jal        MatrixDrive_PopMatrix
    /* DDDC0 001DDDC0 00000000 */   nop
    /* DDDC4 001DDDC4 AE37040C */  jal        PopQuaternion
