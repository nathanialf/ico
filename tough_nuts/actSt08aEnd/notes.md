...
**Reason parked:** rc5 (improved from rc9): void*[] D_004CCDE0 + g=a0 early read + new_var route + [1]-before-0xB4. CORRECT: prologue, s0=actInitialize, branch, KillPlay, v0/v1 (D=v0), [1] store fills BoxBarSoundOn DELAY slot. RESIDUAL (5): lui v0/v1 order (D-first vs chk-first) + addiu a1(0x189) position — coupled w/ delay-occupant via store order, same permuter-class tie as func_00220918. Hand floor confirmed across 24-perm + typing + capture + ptr + dval searches.
