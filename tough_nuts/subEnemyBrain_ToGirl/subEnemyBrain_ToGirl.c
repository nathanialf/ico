...
#define SG_E164(s) (*(int *)((char *)(s) + 0x164))
#define SG_BRAIN(s) (*(int *)(SG_E164(s) + 0x670))
#define SG_SUB(s) (*(int *)((char *)(s) + 0x15C))

typedef struct { char _pad[0x48]; unsigned int f48; } SGNest;

extern void *actInitialize(int *a0);
extern void actInitialize_ext_charcter(int *a0);
extern void actInitialize_only_charcter(int *a0);
extern void actInitialize_geo(int *a0);
extern void ACTGetWish_FromPad(int *a0);
extern void ActPara_InitSystem(int *a0);
extern void ActPara_DebugOut(int *a0);
...
extern void D_0015E110(void);
extern void D_0015A990(void);
extern void actEnemyKidnapEnd(void);
extern void BrainMode_Requset(void);
extern char D_005534C8[];
extern char D_00289658[];
extern char D_005532A0[];
extern float D_00629038;
extern float D_0062903C;
extern int D_0062B034;
extern int D_0062AFC8;
extern float D_0062C50C[];

void subEnemyBrain_ToGirl(int *self) {
    ...
    debug_StdPrintfDummy(D_005534C8, self);
    gval = D_00629038;
    ap = actInitialize(self);
    actInitialize_ext_charcter(self);
    actInitialize_only_charcter(self);
    actInitialize_geo(self);
    ACTGetWish_FromPad(self);
    ActPara_InitSystem(self);
    ActPara_DebugOut(self);
    *(int *)(*(int *)(SG_E164(self) + 0x678) + 0x364) = InitMultiBgaManager(1);

    {
        int sub, brain, g830;
        SubGirlWish work[4] = {
            { 0, 0x1E, 0x12, 0x5A, 0, _ACTGame_GetParamF(0x12), gval, 1 },
            { 1, 0, 0x12, 0x32, 0, _ACTGame_GetParamF(0x13), gval, 0 },
            { 2, 0x1D, 0x16, 0x19, 0x32, _ACTGame_GetParamF(0x14), gval, 0 },
            { 2, 0x1C, 0x16, 0, 0x64, D_0062C50C[0], 338.0f, 1 },
        };
        sub = SG_SUB(self);
        brain = SG_BRAIN(self);
        g830 = *(int *)(sub + 0x830);
        *(int *)(brain + 0x1DC) = 1;
        *(float *)(brain + 0x1D8) = *(float *)(g830 + 0x20);
        *(int *)(SG_BRAIN(self) + 0x1E0) = work[1].f0;
        *(int *)(SG_BRAIN(self) + 0x1E8) = work[1].f4;
        *(float *)((char *)ap + 0x1D4) = work[1].f14;
        *(int *)(SG_BRAIN(self) + 0x1EC) = work[1].f8;
        *(int *)(SG_BRAIN(self) + 0x1F0) = work[1].fc;
        *(int *)(SG_BRAIN(self) + 0x1F4) = work[1].f10;
        *(int *)(SG_BRAIN(self) + 0x1F8) = (int)work[1].f18;
        *(int *)(SG_BRAIN(self) + 0x204) = 3;
        *(long long *)((char *)ap + 0x18) =
            (*(long long *)((char *)ap + 0x18) & ~(1LL << 46)) |
            (((unsigned long long)work[1].f1c & 1) << 46);

        if (*(int *)(SG_BRAIN(self) + 0x1DC) == 3) {
            *(float *)(SG_SUB(self) + 0x44C) = D_0062903C;
            *(float *)(SG_SUB(self) + 0x450) = D_0062903C;
            *(float *)(SG_SUB(self) + 0x454) = D_0062903C;
            *(float *)(SG_SUB(self) + 0x458) = D_0062903C;
        }
        *(int *)(SG_BRAIN(self) + 0x1E4) = D_0062B034;
        _MustChase((int)self);
    }

    flag = (((SGNest *)D_002A0A90)[self[2]].f48 >> 18) & 1;
    if (flag) {
        long long v = *(long long *)((char *)ap + 0x18);
        v &= ~(1LL << 32);
        v &= ~(1LL << 33);
        *(long long *)((char *)ap + 0x18) = v;
    }
    _ACTWait(1);

    *(void **)((char *)ap + 0xB0) = D_00289658;
    if (D_0062AFC8 != 0) {
        actCreateSubThread(BrainMode_Requset, 0x14);
    }
    actCreateSubThread(actEnemyKidnapEnd, 0x15);
    actCreateSubThread(D_0015E110, 0x15);
    actCreateSubThread(D_0015A990, 0x15);
    *(void **)((char *)ap + 0xB4) = D_00289658 + 0x78;
    *(int *)((char *)ap + 0x44) = 2;
    eye = DispEnemyEye(self);
    *(float *)((char *)ap + 0x1D4) = eye;
    *(float *)((char *)ap + 0x1D0) = eye;
    if (eye < 10.0f) {
        *(float *)((char *)ap + 0x1D0) = 10.0f;
        *(float *)((char *)ap + 0x1D4) = 10.0f;
    }
    *(int *)((char *)ap + 0x340) = 0;
    BoxBarSoundOn(self, 0xB4);
    if (flag) {
        long long tmp[2];
        tmp[0] = *(long long *)D_005532A0;
        tmp[1] = *(long long *)(D_005532A0 + 8);
        CylinderCollision(self, (char *)tmp);
        ResetEnemyEye(self);
        actEnemyRun(self);
    }
    _ACTWait(0);
