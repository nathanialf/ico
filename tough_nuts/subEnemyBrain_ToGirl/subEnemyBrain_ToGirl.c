...
void subEnemyBrain_ToGirl(int *self) {
    ...
    debug_assertMessage(D_005534C8, self);
    gval = D_00629038;
    ...
    *(int *)(*(int *)(SG_E164(self) + 0x678) + 0x364) = InitMultiBgaManager(1);

    {
        int sub, brain, g830;
        SubGirlWish work[4] = {
            { 0, 0x1E, 0x12, 0x5A, 0, func_00149D00(0x12), gval, 1 },
            { 1, 0, 0x12, 0x32, 0, func_00149D00(0x13), gval, 0 },
            { 2, 0x1D, 0x16, 0x19, 0x32, func_00149D00(0x14), gval, 0 },
