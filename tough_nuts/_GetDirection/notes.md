...
Seed: `tough_nuts/_GetDirection/094630.c`

Disassembly excerpt:

```
(no asm/cod/*.s found for _GetDirection; check asm/matchings/cod/094630/)
```
...
Seed: `tough_nuts/_GetDirection/094630.c.new`

Disassembly excerpt:

```
glabel _GetDirection
    ...
    /* 94654 00194654 5E0E090C */  jal        sceVu0Normalize
    /* 94658 00194658 0000A1E7 */   swc1      $f1, 0x0($sp)
    /* 9465C 0019465C 0000ACC7 */  lwc1       $f12, 0x0($sp)
    /* 94660 00194660 7679090C */  jal        atan2f
...
**Reason parked:** 3-insn ordering: sd ra/daddu a0/sw zero reversed by ee-as scheduler
