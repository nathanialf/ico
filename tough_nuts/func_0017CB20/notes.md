...
**Reason parked:** retry: daddu a1 vs sw zero in jal delay slot — same near-miss
...
**Reason parked:** daddu a1,sp,zero in jal delay slot vs expected before jal
...
**Reason parked:** daddu a1,sp in jal delay slot vs expected sw 0,4(sp)
