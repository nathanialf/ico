...
**Reason parked:** 5-case jtbl with byte-identical case bodies; ee-gcc 2.9 tail-merges cases 0/1/2 (target has 3 distinct labels for same bytes); -fno-crossjumping not in 2.9, no other obvious switch-dedup-disabling flag
