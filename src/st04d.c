...
inline void actSt04dDoor1UpEffect(volatile int a0){ long long b1[2]; long long b2[2];
 long long v0a=D_00622A40[0]; long long v0b=D_00622A50[0]; int i;
 for(i=0;i<0x32;i++){ switch(i){
  case 0: b1[0]=v0a; b1[1]=D_00622A40[1]; scpEffectStart((int*)b1,0); break;
  case 0x1E: b2[0]=v0b; b2[1]=D_00622A50[1]; scpEffectStart((int*)b2,0); break;
  } _ACTWait(1); } }
inline void actSt04dDoor1DownEffect(volatile int a0){ long long b1[2]; long long b2[2];
 long long v0a=D_00622A50[0]; long long v0b=D_00622A40[0]; int i;
 for(i=0;i<0x32;i++){ switch(i){
  case 0: b1[0]=v0a; b1[1]=D_00622A50[1]; scpEffectStart((int*)b1,0); break;
  case 0x1E: b2[0]=v0b; b2[1]=D_00622A40[1]; scpEffectStart((int*)b2,0); break;
  } _ACTWait(1); } }
...
inline void actSt04dDoor2UpEffect(volatile int a0){ long long b1[2]; long long b2[2];
...
inline void actSt04dDoor2DownEffect(volatile int a0){ long long b1[2]; long long b2[2];
