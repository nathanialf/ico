...
void actSt13bDoor(volatile int a0) {
    ...
    D_006325B4 = 1;
    _ACTWait__p4(1);
    stage_KillPlayBgAnimation__p4(0x140, 1, 0);
...
void actSt13bConte02Jimaku(volatile int a0) {
    if (D_00631AE8__p4 == 0) { _ACTWait__p4(0); }
...
void actSt13bMeetAgainChk(volatile int a0){ int a; int b;
 ...
 stage_KillPlayBgAnimation__p4(0x59,1,0);
 while(func_0012AA80(0x59)==0) _ACTWait__p4(1); _ACTWait__p4(1);
