...
/* func_00200970 / func_002009F0 were matched with these spellings; kept verbatim so their alias sets are unchanged. */
...
#define EnvAssistTail(tmp_, anch_, dst_, ascale_) { \
    ...
    sceVu0AddVector((float *)(dst_), (float *)(dst_), (float *)(tmp_)); \
}
...
L6B4:
        ...
        if (*(int *)(sub + 0x188) != 0) {
            ...
            *(float *)((char *)arg4 + 0xC) = 1.0f;
            ...
            if (s7 != 0 && f22 < f25) {
                int a;
                sceVu0ScaleVector(FP(0x70), arg4, -1.0f);
                a = __builtin_abs(_RotyGV(boy, (float *)&f70));
    ...
    if (f22 != D_00633850[0] && s6 != 0 && FI(0x1B4) != 0) {
        ...
        *(int *)arg3 |= 1;
        ...
        mo = D_00565060 + *(int *)(*(char **)((char *)FI(0x30) + 0x15C) + 0x4A0);
        s18 = 1;
        {
        ...
        if (f22 < 120.0f && b6 != 0) {
            char *q;
            w60b = (char *)&f68 - 8;
            sceVu0ScaleVector(w60b, arg4, f22);
            ...
            *(int *)(q + 0x794) = 0x14;
            *(float *)(q + 0x790) = 40.0f;
            *(int *)((char *)*(int *)((char *)*(int *)((char *)FI(0x30) + 0x164) + 0x678) + 0x798) = 1;
        ...
        L10d:;
            ...
            if (stt == 0x16) {
                ...
                *(int *)((char *)arg4 + 0x14C) = (int)box;
                ...
                sceVu0ScaleVector((float *)w70, (float *)arg4, -10.0f);
                func_001945B8((float *)w70, 1.5707964f);
                sceVu0AddVector((float *)((char *)arg4 + 0xF0), (float *)((char *)arg4 + 0xF0), (float *)w70);
                stt = *(int *)(box + 0xC);
                goto L16d;
            L16e:
                stt = *(int *)(box + 0xC);
                ...
                *(float *)((char *)arg4 + 0xA8) = *(float *)((char *)arg4 + 0x8);
                {
                    ...
                    w = head;
                    do {
                        sceVu0AddVector((float *)w70v, (float *)w70v, (float *)w);
                        w += 0x10;
                        i--;
                    } while (i >= 0);
                    sceVu0ScaleVector((float *)dstc, (float *)w70v, 0.25f);
                }
        ...
        if (f22 < 50.0f) {
            int a;
            sceVu0ScaleVector(FP(0x70), arg4, -1.0f);
            a = __builtin_abs(_RotyGV((void *)FI(0x1A8), (float *)&f70));
            if (a < 0x28) {
    ...
    if (f21 != D_00633850[0] &&
        ...
        *(float *)((char *)arg4 + 0x1C) = 1.0f;
        ...
        if ((char *)FI(0x30) == (char *)D_00631AE4 && (char *)D_00631AE8 != 0) {
            ...
            FF(0x68) = *(float *)(pp2 + 8);
            w60c = (char *)&f6C - 12;
            d2 = _DistSqGV((void *)FI(0x1C4), w60c);
            {
            ...
            if (d2 < rowf * rowf) {
                sceVu0SubVector(FP(0xB0), w60c, (char *)&f50 - 0x40);
                w70f = (char *)&f74 - 4;
                _OrientGV(w70f, (void *)FI(0x1C8));
                ((union IFAlias *)&fBC)->i = 0;
                sceVu0ApplyMatrix(FP(0xC0), w70f, FP(0xB0));
                if (0.0f < FF(0xC8)) {
                    wFlag = 1;
                }
            }
        ...
        }
        {
            ...
            if ((char *)FI(0x30) == (char *)D_00631AE4 && (char *)D_00631AE8 != 0 &&
                *(int *)(*(char **)((char *)D_00631AE8 + 0x164) + 0x30) != 0x26 &&
                ...
                FI(0x1CC) = 1; rootUpd = -EnableChangeRootUpdateMode((void *)D_00631AE4, (void *)D_00631AE8);
                if (!(f21 < 60.0f)) {
                    FI(0x1CC) = 0;
                }
                m = (char *)&f64 - 4;
                ...
                GetRootPosition((float *)w70v, (void *)D_00631AE8);
                if (!(f24 < 55.0f)) {
                    if (f24 < 155.0f) {
                        f22 = 80.0f;
                        ccat = 0x64;
                ...
                if (!(ccat < 0xC8)) {
                    ...
                    FF(0xA8) = FF(0x8);
                    gH = (char *)FP(0x90);
                    sceVu0ScaleVector(gH, (void *)FI(0x1C8), f21 + 50.0f);
                    pb = (char *)&fB0;
                    sceVu0AddVector((float *)pb, FP(0xA0), gH);
                ...
                if (ccat != 0 && f22 < rootUpd) {
                    if (FI(0x1D0) != 0) {
                        ...
                        gI = (char *)FP(0x140);
                        GetRootPosition(gI, (void *)FI(0x30));
                        pC = (char *)FP(0x130);
                        sceVu0ScaleVector(pC, (void *)FI(0x1C8), f21);
                        sceVu0AddVector((char *)arg4 + 0x50, gI, pC);
                        q = (char *)&w150;
                        q = (char *)*(int *)(q + 4);
                        ...
                        pD = (char *)FP(0x150);
                        sceVu0ScaleVector(pD, (void *)FI(0x1C8), f21 - 30.0f);
                                ...
                                if (fnd2 != 0) {
                                    ...
                                    if (RotateAccordingToStick_PatternThree((int)p1, p2) < 22500.0f &&
                                        ...
                                        Lcfix:
                                            ...
                                            ccat = (int)*(long long *)&y1A8;
                                            ccat = (int)*(long long *)&y1AC;
                                            ccat = 0xC8;
    ...
    Lchainbody:
        {
            ...
            *(int *)((char *)arg4 + 0x15C) = (int)hit;
            ...
            pp = (char *)ContinueCorrectPosition(hit);
            y1A8 = *(float *)(pp + 8);
            sceVu0ScaleVector((void *)&dv19, (void *)FI(0x1C8), -20.0f);
    ...
    if (vw == (char *)D_00631AE4 &&
        ...
        char *w;
        if (*(int *)(env + 0x140) != 0) {
            w = (char *)WeaponHitEffect((void *)*(int *)(env + 0x140), g8, 150.0f);
        } else {
            ...
            if (*(int *)(*(char **)(g + 0x164) + 0x30) == 0x64) {
                if (GetMotionFrameFlag1(g)) {
                    if (func_00145328((void *)FI(0x30), (void *)D_00631AE8, 0x78, FP(0x60),
                        ...
                        char *b;
                        char *pp;
                        b = (char *)ACTGame_GetNearestGObj((int)(char *)ContinueCorrectPosition(g), 0x21);
    ...
    if ((char *)FI(0x30) == (char *)D_00631AE4) {
        ...
        if (ACTGame_ConnectHand((void *)FI(0x30)) == 0) {
            char *r2 = (char *)ACTGame_isWeaponEnableCatchfire((void *)*(int *)(env + 0x140));
            if (r2 != 0) {
                if (TorchGeo(r2) == 0) {
                    if (t30v != 0) {
...
void func_00200970(void *a0, void *a1)
{
    ...
    if ((char *)a0 == (char *)D_00631AE4) *(float *)w70 = -*(float *)w70;
    {
        ...
        sceVu0ApplyMatrix(m6 + 0x5A0, hp, w70);
    }
}
