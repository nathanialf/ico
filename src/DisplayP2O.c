...
INCLUDE_ASM("asm/nonmatchings/src/DisplayP2O", RotQuaternionEAZ);

INCLUDE_ASM("asm/nonmatchings/src/DisplayP2O", GetXUnitVectorOfQuaternion);

INCLUDE_ASM("asm/nonmatchings/src/DisplayP2O", GetYUnitVectorOfQuaternion);

INCLUDE_ASM("asm/nonmatchings/src/DisplayP2O", GetZUnitVectorOfQuaternion);

INCLUDE_ASM("asm/nonmatchings/src/DisplayP2O", GetDifferencialQuaternionWithNoRegularize);
...
INCLUDE_ASM("asm/nonmatchings/src/DisplayP2O", GetTableCos);

INCLUDE_ASM("asm/nonmatchings/src/DisplayP2O", InitTableSin);

INCLUDE_ASM("asm/nonmatchings/src/DisplayP2O", GetTableArcSin);

INCLUDE_ASM("asm/nonmatchings/src/DisplayP2O", GetTableArcCos);

extern short GetTableArcCos(float c);

short GetTableArcTan2(float s, float c)
{
    if (s < 0.0f) {
        return -GetTableArcCos(c);
    }
    return GetTableArcCos(c);
}
...
void p2o_HideDispVU1(int a0)
{
    D_00631B84 = a0;
    if (D_00632CE0 != 0) {
        debug_PrintFontWindow(0xCCCCCC00, D_00553E90, a0);
    }
}
