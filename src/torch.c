...
} S_bl_0061A8F0;  /* stride 0x4, 1 accesses */

typedef struct {
    unsigned int     f_0;  /* 0x0  x1 */
} S_bl_0061A9C0;  /* stride 0x4, 1 accesses */

typedef struct {
    unsigned int     f_0;  /* 0x0  x1 */
} S_bl_0061AA20;  /* stride 0x4, 1 accesses */

typedef struct {
    unsigned int     f_0;  /* 0x0  x1 */
} S_bl_0061AAB0;  /* stride 0x4, 1 accesses */

typedef struct {
    unsigned int     f_0;  /* 0x0  x1 */
} S_bl_0061AC40;  /* stride 0x4, 1 accesses */
