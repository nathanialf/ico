...
{
    sceDmaSend(D_0063378C, D_00276214[0]);
}
...
INCLUDE_ASM("asm/nonmatchings/src/FileManager", gif_EndPacketPath1);

INCLUDE_ASM("asm/nonmatchings/src/FileManager", func_0010F880);

INCLUDE_ASM("asm/nonmatchings/src/FileManager", func_0010F9A8);

INCLUDE_ASM("asm/nonmatchings/src/FileManager", gif_MakeSpriteOffset);

INCLUDE_ASM("asm/nonmatchings/src/FileManager", gif_MakeSpriteWithStrip);

INCLUDE_ASM("asm/nonmatchings/src/FileManager", gif_PointOffset);

INCLUDE_ASM("asm/nonmatchings/src/FileManager", gif_Line);

INCLUDE_ASM("asm/nonmatchings/src/FileManager", gif_Sprite);
