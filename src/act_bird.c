...
float vector_angle_degree(void *a0, void *a1) {
    ...
    return func_0025E3D8(sceVu0InnerProduct(v0, v1)) * 360.0f / 6.2831855f;
}
...
void *Debug_WireString_Bird(void *a0, void *a1) {
    ...
    *(volatile float *)(BIRD_HDR(a0) + 0x4AC) = _GetRandom() * 100.0f;
    {
        int hdr = BIRD_HDR(a0);
